...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBProjectTypeController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${tBProjectTypePage.id }">
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					<td align="right">
						<label class="Validform_label">项目类型：</label><font color="red">*</font>
					</td>
					<td class="value">
				    <input id="projectTypeName" name="projectTypeName" type="text" style="width: 150px" class="inputxt"
            validType="t_b_project_type,PROJECT_TYPE_NAME,id"	datatype="*1-25" >
				...
				<%-- <tr>
					...
					<td class="value">
				     	<input id="officer" name="officer" type="hidden">
				     	<input id="realname" type="text" style="width: 150px" class="inputxt" readonly="readonly"><br>
				...
				<tr>
					...
					<td class="value">
				     	<input id="sortCode" name="sortCode" type="text" style="width: 150px" class="inputxt" datatype="n1-6">
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	<textarea id="memo" name="memo" style="width: 150px; height:60px;" datatype="*1-100" ignore="ignore"></textarea>
						<span class="Validform_checktip"></span>
