...
<html>
 <head>
  ...
  $(function(){
	  $("#approvalBudgetRelaId").combobox({
		  ...
		  valueField: 'id',
		  value:'${tBFundsBudgetRelaPage.approvalBudgetRelaId}',
	      textField: 'text',
	      panelHeight:150,
	      editable:false,
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" 
  	action="tBFundsBudgetRelaController.do?doAddOrUpdate" 
  	tiptype="1" tipSweep="true" beforeSubmit="valiBudBeforeSubmit" >
		<input id="id" name="id" type="hidden" value="${tBFundsBudgetRelaPage.id }">
			...
			<tr>
				...
				<td class="value">
			     	<input id="millionUp" name="millionUp" type="text" 
			     		...
			     		value="${tBFundsBudgetRelaPage.millionUp}">%
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
			     	<input id="millionDown" name="millionDown" type="text" 
			     		style="width:135px; text-align:right;" class="easyui-numberbox"
			     		data-options="min:0,max:99.99,precision:2,groupSeparator:','"
			     		value="${tBFundsBudgetRelaPage.millionDown}">%
					<span class="Validform_checktip"></span>
			...
			<tr>
				...
				<td class="value">
			     	<textarea id="memo" name="memo" style="width:150px; height:60px;" 
			     		datatype="*1-100" ignore="ignore">${tBFundsBudgetRelaPage.memo}</textarea>
					<span class="Validform_checktip"></span>
