...
<div class="easyui-layout" fit="false" style="height:400px;">
  ...
  <t:datagrid name="tBResultSpreadList" checkbox="true" fitColumns="true" title="成果推广基本信息表" actionUrl="tBResultSpreadController.do?datagrid&projectId=${projectId}" idField="id" fit="true" queryMode="group">
