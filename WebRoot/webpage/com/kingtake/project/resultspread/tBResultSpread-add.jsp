...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBResultSpreadController.do?doAdd" tiptype="1"  callback="@Override uploadFile">
