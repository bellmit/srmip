...
<div style="width: 100%;height:300px;">
  <t:datagrid name="tBResultSpreadList" checkbox="true" fitColumns="true" title="${projectName}:成果推广基本信息表" actionUrl="tBResultSpreadController.do?datagrid&projectId=${projectId}" idField="id" fit="false" queryMode="group">
