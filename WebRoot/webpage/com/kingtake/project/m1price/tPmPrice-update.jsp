...
<body>
  <t:formvalid formid="formobj" dialog="true" layout="table" action="tPmPriceController.do?doUpdate" tiptype="1" tipSweep="true" callback="@Override uploadFile">
    ...
    <input id="createBy" name="createBy" type="hidden" value="${tPmPricePage.createBy }">
    <input id="createName" name="createName" type="hidden" value="${tPmPricePage.createName }">
    <input id="createDate" name="createDate" type="hidden" value="${tPmPricePage.createDate }">
    <input id="updateBy" name="updateBy" type="hidden" value="${tPmPricePage.updateBy }">
    <input id="updateName" name="updateName" type="hidden" value="${tPmPricePage.updateName }">
    <input id="updateDate" name="updateDate" type="hidden" value="${tPmPricePage.updateDate }">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
      <tr>
        ...
        <td class="value">
          <input id="title" name="title" type="text" style="width: 300px" class="inputxt" datatype="*1-100" value="${tPmPricePage.title}">
      ...
      <tr>
        ...
        <td class="value">
          <input id="contractId" name="contractId" style="width: 305px;" value="${tPmPricePage.contractId}">
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value">
          <input id="contractType" name="contractType" type="hidden" value="${tPmPricePage.contractType}">
          <c:if test="${tPmPricePage.contractType eq 'i'}">
            <input id="contractTypeName" name="contractTypeName" type="text" value='进账' style="width: 300px" class="inputxt" disabled="disabled" readonly="readonly" />
          </c:if>
          <c:if test="${tPmPricePage.contractType eq 'o'}">
            <input id="contractTypeName" name="contractTypeName" type="text" value='出账' style="width: 300px" class="inputxt" disabled="disabled" readonly="readonly" />
          </c:if>
        </td>
      </tr>
      <tr>
