...
<script type="text/javascript">
	...
	<t:formvalid formid="formobj" dialog="true" layout="table" action="tPmContractNodeCheckController.do?doUpdate" tiptype="1" callback="@Override saveCallback">
