...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:1px;">
		<t:datagrid name="tPmContractNodeCheckList" checkbox="false" fitColumns="false" 
			actionUrl="tPmContractNodeCheckController.do?outcomeContractNodeDatagrid&datagridType=${datagridType}&operateStatus=${operateStatus}" 
...
<script type="text/javascript" src="webpage/com/kingtake/project/contractnodecheck/outcomeContractNodeCheckList-receive.js"></script>	
<script type="text/javascript">
	...
	function handlerNodeCheckAppr(apprId,receiveId,apprStatus){
		...
		handlerAppr1(title, url, width, height, apprStatus, finish, receiveId);
	}
