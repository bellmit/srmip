...
$(function(){
	...
	$.ajax({
		   url:'tPmContractNodeCheckController.do?checkIsAppr',
		   data:{"apprId":"${apprId}"},
		   type:'POST',
		   dataType:'json',
...
<t:tabs id="contractNodeInfo" iframe="false" tabPosition="top">
	...
	<!-- 合同节点验收信息 -->
	<t:tab iframe="tPmContractNodeCheckController.do?goUpateOutContractNodeCheck&id=${apprId}&load=detail" icon="icon-search"
		title="合同节点验收信息" id="tPmContractNodeCheck" ></t:tab>
