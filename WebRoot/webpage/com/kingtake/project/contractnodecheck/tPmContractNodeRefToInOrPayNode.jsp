...
<div id="main_div" class="easyui-layout" fit="true">
	...
	<t:datagrid name="tPmProjectList" checkbox="false" fitColumns="false" title="项目基本信息表" 
		actionUrl="tPmProjectController.do?datagridForContractCheck" idField="id" fit="true" queryMode="group"
		...
		<t:dgFunOpt funname="return false;" title="查看合同节点"></t:dgFunOpt>
	...
	<div style="width: 740px; overflow: hidden;" id="eastPanel"
		data-options = 
			"
				region:'east',
				title:'mytitle',
...
<script type="text/javascript">
	...
	function queryContractNode(id){
		...
		var url = "tPmContractNodeCheckController.do?tPmContractNodeCheck" +
				"&inOutFlag=" + inOutFlag +
				"&projectId=" + id;
