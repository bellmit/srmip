...
<div style="width: 100%;height:300px;">
  <t:datagrid name="tBResultRewardList" fitColumns="true" title="${projectName }：成果奖励" actionUrl="tBResultRewardController.do?datagrid&projectId=${projectId}&datagridType=${datagridType}" idField="id" onDblClick="dbClick" fit="false" queryMode="group">
   ...
   <t:dgFunOpt exp="finishFlag#eq#1" title="完成" funname="updateIncomeApprFinishFlag(id)" ></t:dgFunOpt>
   <t:dgFunOpt exp="finishFlag#eq#2" title="取消完成" funname="updateIncomeApprFinishFlag(id)" ></t:dgFunOpt> --%>
   <t:dgToolBar title="录入" icon="icon-add" url="tBResultRewardController.do?goAdd&projectId=${projectId }" funname="add" width="770" height="500"></t:dgToolBar>
