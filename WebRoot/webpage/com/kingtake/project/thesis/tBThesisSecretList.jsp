...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBThesisSecretList" onDblClick="goDetail" checkbox="false" fitColumns="true" title="论文保密申请信息表" actionUrl="tBThesisSecretController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgFunOpt exp="checkFlag#eq#0" funname="goUpdate(id)" title="编辑"></t:dgFunOpt>
...
<%--    <t:dgToolBar title="编辑" icon="icon-edit" funname="goAddOrupdate" width="765" height="650"></t:dgToolBar> --%>
...
function goAdd(){
	$.dialog({
		content: 'url:tBThesisSecretController.do?goUpdate',
		lock : true,
		width : '765px',
		height : window.top.document.body.offsetHeight-100,
 		top : '0%',
...
function goUpdate(id){
	$.dialog({
		content: 'url:tBThesisSecretController.do?goUpdate&id='+id,
		lock : true,
		width : '765px',
		height : window.top.document.body.offsetHeight-100,
 		top : '0%',
...
function goDetail(rowIndex){
	...
	var id = rows[0].id;
	$.dialog({
		content: 'url:tBThesisSecretController.do?goUpdate&id='+id+'&load=detail',
		lock : true,
		width : '765px',
		height : window.top.document.body.offsetHeight-100,
 		top : '0%',
