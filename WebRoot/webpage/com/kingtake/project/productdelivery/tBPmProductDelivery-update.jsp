...
<body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tBPmProductDeliveryController.do?doUpdate">
    <input id="id" name="id" type="hidden" value="${tBPmProductDeliveryPage.id }">
    <input id="projectId" name="projectId" type="hidden" value="${tBPmProductDeliveryPage.projectId }">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable">
      ...
      <tr>
        ...
        <td class="value">
          <input id="contractCode" name="contractCode" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.contractCode}' readonly="true" datatype="*" min="1">
        ...
        <td class="value">
          <input id="contractName" name="contractName" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.contractName}' readonly="true" datatype="*" min="1">
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value">
          <input id="deliverUnit" name="deliverUnit" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.deliverUnit}' datatype="byterange" max="120" min="1" >
          <span class="Validform_checktip"></span>
        ...
        <td class="value">
          <input id="receiveUnit" name="receiveUnit" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.receiveUnit}' datatype="byterange" max="120" min="1" >
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value">
          <input id="deliverName" name="deliverName" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.deliverName}' datatype="byterange" max="36" min="1" >
          <span class="Validform_checktip"></span>
        ...
        <td class="value">
          <input id="receiveName" name="receiveName" type="text" style="width: 150px" class="inputxt" value='${tBPmProductDeliveryPage.receiveName}' datatype="byterange" max="36" min="1" >
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value">
          <input id="deliverDate" name="deliverDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"
            value='<fmt:formatDate value='${tBPmProductDeliveryPage.deliverDate}' type="date" pattern="yyyy-MM-dd"/>' datatype="date" >
          <span class="Validform_checktip"></span>
        ...
        <td class="value">
          <input id="receiveDate" name="receiveDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"
            value='<fmt:formatDate value='${tBPmProductDeliveryPage.receiveDate}' type="date" pattern="yyyy-MM-dd"/>' datatype="date" >
          <span class="Validform_checktip"></span>
  ...
  <table style="display: none">
    <tbody id="add_tBPmProductDetail_table_template">
      <tr>
        <td align="center">
          <input name="tBPmProductDetailList[#index#].proeuctDeliveryId" type="hidden" value="${tBPmProductDeliveryPage.id}">
          <input style="width: 30px;" type="checkbox" name="ck" />
        </td>
        <td align="left">
          <input name="tBPmProductDetailList[#index#].serialNum" maxlength="4" type="text" class="inputxt" style="width: 25px;" datatype="n1-4">
