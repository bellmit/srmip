...
<%--<div class="easyui-layout" fit="false" style="height:250px;">--%>
  <%--<div region="center" style="padding: 1px;">--%>
<div style="width: 100%;height:300px;">
    <t:datagrid name="tBPmProjectChangeList" title="${projectName}-项目名称变更" checkbox="false" fitColumns="true" actionUrl="tBPmProjectChangeController.do?datagrid&projectId=${projectId}" idField="id" fit="false" queryMode="group"
...
<script type="text/javascript">
    ...
    $(document).ready(
            function() {
                ...
                $("#tBPmProjectChangeList").datagrid({
                    height:300
                });
            });
