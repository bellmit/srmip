...
<t:datagrid fitColumns="true" name="myTaskList" queryMode="group" title="我的任务列表" pagination="false" actionUrl="tBPmChangeProjectnameController.do?taskAllList&businessCode=${businessCode}" idField="id">
<t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
 <t:dgCol title="流程编号" field="Process_processDefinition_id" width="80" hidden="true" ></t:dgCol>
 <t:dgCol title="流程" field="Process_processDefinition_name" width="150" hidden="true"></t:dgCol>
