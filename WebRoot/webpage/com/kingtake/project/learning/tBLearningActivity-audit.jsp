    ...
    <table cellpadding="0" cellspacing="1" class="formtable">
      ...
      <tr>
        ...
        <td colspan="3" class="value">
          <input type="hidden" value="${tBLearningActivityPage.id}" id="bid" name="bid" />
          <table style="max-width: 360px;">
            <c:forEach items="${tBLearningActivityPage.uploadFiles}" var="file" varStatus="idx">
              <tr style="height: 30px;">
                <td>
                  <a href="javascript:void(0);"
                    onclick="createDetailChildWindow('预览','commonController.do?goAccessoryTab&bid=${tBLearningActivityPage.id}&index=${idx.index}&subclassname=org.jeecgframework.web.system.pojo.base.TSFilesEntity',1000,700)">${file.attachmenttitle}</a>
                  &nbsp;&nbsp;&nbsp;
                </td>
                <td style="width: 40px;">
          ...
          <div>
            ...
            <t:upload name="fiels" id="file_upload" extend="*.doc;*.docx;*.txt;*.ppt;*.xls;*.xlsx;*.html;*.htm;*.pdf;*.jpg;*.zip;" buttonText="添加文件" formData="bid"
              uploader="commonController.do?saveUploadFiles&businessType=learningActivity"></t:upload>
          </div>
        </td>
      </tr>
    </table>
