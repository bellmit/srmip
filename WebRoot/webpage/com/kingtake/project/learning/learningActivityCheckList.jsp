...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding: 1px;">
    <t:datagrid name="tBLearningActivityList" checkbox="true" fitColumns="true" title="学术著作信息表" actionUrl="tBLearningActivityController.do?checkList&businessCode=learning_activity" pagination="false"
      ...
      <t:dgCol title="活动级别" field="activityLevel" codeDict="1,XSHDJB" width="100"></t:dgCol>
...
<script type="text/javascript">
    ...
    function dblDetail(rowIndex, rowDate) {
        ...
        var height = '100%';
        var role = $("#role").val();
        var url = "tBLearningActivityController.do?goAddUpdate&load=detail&role=" + role + "&id=" + rowDate.id;
