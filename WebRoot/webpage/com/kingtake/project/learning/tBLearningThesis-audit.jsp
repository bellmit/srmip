        ...
        $('#file_upload1').uploadify(
                {
                    ...
                    uploader : 'commonController.do?saveUploadFiles&businessType=eEdition',
        ...
        $('#file_upload2').uploadify(
                {
                    ...
                    fileSizeLimit : '500MB',
                    swf : 'plug-in/uploadify/uploadify.swf',
                    uploader : 'commonController.do?saveUploadFiles&businessType=coverPic',
                    onUploadStart : function(file) {
                        var bid = $('#bid').val();
                        var projectId = $('#projectId').val();
        ...
        $('#file_upload3').uploadify(
                {
                    ...
                    fileSizeLimit : '500MB',
                    swf : 'plug-in/uploadify/uploadify.swf',
                    uploader : 'commonController.do?saveUploadFiles&businessType=directoryPic',
                    onUploadStart : function(file) {
                        var bid = $('#bid').val();
                        var projectId = $('#projectId').val();
        ...
        $('#file_upload4').uploadify(
                {
                    ...
                    fileSizeLimit : '500MB',
                    swf : 'plug-in/uploadify/uploadify.swf',
                    uploader : 'commonController.do?saveUploadFiles&businessType=homePagePic',
                    onUploadStart : function(file) {
                        var bid = $('#bid').val();
                        var projectId = $('#projectId').val();
...
<body>
  ...
  <t:formvalid formid="formobj" dialog="true" layout="table" action="tBLearningThesisController.do?doAddUpdate" tiptype="1" callback="@Override uploadFiles">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable" style="border-collapse: collapse;">
      <tr>
        <td align="right">
          <label class="Validform_label">中文题名:</label><font color="red">*</font>
        </td>
        <td class="value" colspan="3">
          <input id="titleCn" name="titleCn" type="text" style="width: 80%" class="inputxt" value='${tBLearningThesisPage.titleCn}' datatype="byterange" max="300" min="1"  title="300字以内">
       ...
       <tr>
        ...
        <td class="value" colspan="3">
          <input id="titleEn" name="titleEn" type="text" style="width: 80%" class="inputxt" value='${tBLearningThesisPage.titleEn}' datatype="*1-300" ignore="ignore">
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value" colspan="3">
          <input id="magazineName" name="magazineName" type="text" style="width: 80%" class="inputxt" value='${tBLearningThesisPage.magazineName}' datatype="byterange" max="60" min="1" title="60字以内">
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value" colspan="3">
          <textarea id="keyword" name="keyword" style="width: 80%" class="inputxt" datatype="byterange" max="200" min="1" title="多个关键词请用分号分隔，如关键词1；关键词2" placeholder="多个关键词请用分号分隔，如关键词1；关键词2">${tBLearningThesisPage.keyword}</textarea>
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td class="value" colspan="3">
          <textarea id="summary" style="width: 80%;" class="inputxt" rows="6" name="summary" datatype="byterange" max="800" min="1">${tBLearningThesisPage.summary}</textarea>
          <span class="Validform_checktip"></span>
      ...
      <tr>
        ...
        <td colspan="3" class="value">
          <input type="hidden" value="${tBLearningThesisPage.id }" id="bid" name="bid" />
          <table style="max-width: 360px;">
            <c:forEach items="${tBLearningThesisPage.editions}" var="file" varStatus="idx">
              <tr style="height: 30px;">
                <td>
                  <a href="javascript:void(0);"
                    onclick="createDetailChildWindow('预览','commonController.do?goAccessoryTab&bid=${tBLearningThesisPage.id}&index=${idx.index}&subclassname=org.jeecgframework.web.system.pojo.base.TSFilesEntity',1000,700)">${file.attachmenttitle}</a>
                  &nbsp;&nbsp;&nbsp;
                </td>
                <td style="width: 40px;">
