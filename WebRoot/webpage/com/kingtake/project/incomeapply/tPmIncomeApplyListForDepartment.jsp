...
<div class="easyui-layout" fit="true" style="height: 500px;">
  <div region="center" style="padding: 1px;">
    <t:datagrid name="tPmIncomeApplyList" fitColumns="true" title="认领经费" actionUrl="tPmIncomeApplyController.do?datagridForWord" idField="id" fit="true"
      queryMode="group">
      ...
      <t:dgFunOpt title="生成到款分配通知书" funname="exportWord(id)" />  
	</t:datagrid>
  </div>
</div>
<script type="text/javascript">
    ...
    function exportWord(id) {    	
    	if(id == ""){
    		...
    		$.ajax({
                url : 'tPmIncomeApplyController.do?createWord&id=' + id,
                type : 'post',
                dataType : 'json',
                success : function(data) {
