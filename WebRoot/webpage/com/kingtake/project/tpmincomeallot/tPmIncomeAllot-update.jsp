...
<body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPmIncomeAllotController.do?doUpdate" beforeSubmit="checkAmount" tiptype="1" callback="@Override callback">
