...
<body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPmIncomeAllotController.do?doAdd" beforeSubmit="checkAmount" tiptype="1" callback="@Override callback">
    ...
    <input id="incomeId" name="income.id" type="hidden" value="${income.id}">
    <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
      ...
      <tr>
        ...
        <td class="value"><input id="projectName" name="projectName" type="text" style="width: 150px" class="inputxt" value='${tPmIncomeAllotPage.projectName}' datatype="*"> <t:chooseProject
            inputName="projectName" inputId="projectId" mode="single" fun="findInfoById" all="true"></t:chooseProject> <span class="Validform_checktip"></span> <label class="Validform_label"
      ...
      <tr>
        ...
        <td class="value"><input id="projectMgrDept" name="projectMgrDept" type="text" style="width: 150px" class="inputxt" value='${tPmIncomeAllotPage.projectMgrDept}' readonly="readonly">
          <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">负责人单位</label></td>
      </tr>
      <tr>
        ...
        <td class="value"><input id="incomeDept" name="incomeDept" type="text" style="width: 150px" class="inputxt" value='${tPmIncomeAllotPage.incomeDept}'> <span
            class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">分配单位</label></td>
      </tr>
      <tr>
        <td align="right"><label class="Validform_label">
