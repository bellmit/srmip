...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tPmProjectMemberList" fitColumns="false" title="项目组成员" actionUrl="tPmProjectMemberController.do?datagrid&project.id=${projectId}" idField="id" fit="true" queryMode="group">
...
<%--    <t:dgDelOpt title="删除" url="tPmProjectMemberController.do?doDel&id={id}" /> --%>
<%--    <t:dgToolBar title="录入" icon="icon-add" url="tPmProjectMemberController.do?goAdd&projectId=${projectId}" funname="add"></t:dgToolBar> --%>
<%--    <t:dgToolBar title="编辑" icon="icon-edit" url="tPmProjectMemberController.do?goUpdate&projectId=${projectId}" funname="update"></t:dgToolBar> --%>
<%--    <t:dgToolBar title="批量删除"  icon="icon-remove" url="tPmProjectMemberController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
<%--    <t:dgToolBar title="查看" icon="icon-search" url="tPmProjectMemberController.do?goUpdate" funname="detail"></t:dgToolBar> --%>
