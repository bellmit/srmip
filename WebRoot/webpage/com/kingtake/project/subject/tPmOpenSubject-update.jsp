...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPmOpenSubjectController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						  	 	<textarea id="technicalIndicator" style="width:600px;" class="inputxt" rows="6" name="technicalIndicator">${tPmOpenSubjectPage.technicalIndicator}</textarea>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="researchContents" style="width:600px;" class="inputxt" rows="6" name="researchContents">${tPmOpenSubjectPage.researchContents}</textarea>
							<span class="Validform_checktip"></span>
