...
<div class="easyui-layout" fit="true">
 ...
 <t:datagrid name="tBAppraisaApprovalList" checkbox="false" fitColumns="false" 
 	actionUrl="tBAppraisaApprovalController.do?datagrid&operateStatus=${operateStatus}" 
  ...
  <t:dgCol title="项目性质" field="project_character" queryMode="single" width="120" codeDict="1,CGJDXMXZ"></t:dgCol>
  <t:dgCol title="鉴定条件" field="appraisa_condition" queryMode="group" width="120" codeDict="1,JDTJ"></t:dgCol>
  ...
  <t:dgCol title="联系人" field="contact_username" queryMode="group" width="80" ></t:dgCol>
