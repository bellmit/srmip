...
<div id="main_div" class="easyui-layout" fit="true">
	<div region="center" style="padding:1px;">
		...
		<t:dgFunOpt funname="doNothing" title="查看合同"></t:dgFunOpt>
...
<div style="width: 700px; overflow: hidden;" id="eastPanel"
	data-options = 
		"
			region:'east',
			title:'mytitle',
	...
	<!-- 合同审批表信息 -->
 <div class="easyui-panel" style="padding: 1px;" fit="true" border="false" id="contractAppr"></div>
</div>
</div>
<script type="text/javascript">
	...
	function queryContractNode(id){
		...
		var url = "tPmContractCheckController.do?tPmContractCheck" +
				"&projectId=" + id;
		$('#contractAppr').panel("refresh", url);
