...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPmQualitySystemFileController.do?doAdd" tiptype="1" callback="@Override uploadFile">
