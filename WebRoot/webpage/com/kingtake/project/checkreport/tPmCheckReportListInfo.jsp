...
<div style="width: 100%;height: 300px;">
    <t:datagrid name="tPmCheckReportList" checkbox="true" fitColumns="true"
                title="中期检查报告" actionUrl="tPmCheckReportController.do?datagrid&projectId=${projectId}" idField="id" fit="false"
