...
<div class="easyui-layout" fit="true" id="contentContainer">
	...
	<div 
		...
		<div class="easyui-panel" style="padding: 1px;" fit="true" border="false" id="payNodeList"></div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function openPriceWin(id, type){
		...
		var title = "价款计算书";
		var url = 'tPmContractPriceCoverController.do?tPmContractPriceCover&read=1'+
