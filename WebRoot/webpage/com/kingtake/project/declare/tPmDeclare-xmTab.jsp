...
<t:tabs id="addFinishApplyInfo" iframe="false" tabPosition="top">
  <t:tab href="tPmApprLogsController.do?tPmApprLogsTable&apprId=${apprId}&apprType=20&send=${send}&idFlag=${idFlag}&sptype=${sptype}&bmlx=${bmlx}" icon="icon-search" title="审核信息" id="apprLogs"></t:tab>
