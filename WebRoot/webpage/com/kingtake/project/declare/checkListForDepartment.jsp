...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding: 1px;">
    <t:datagrid name="tPmDeclareList" checkbox="true" fitColumns="true" actionUrl="tPmDeclareController.do?checkListDepartement&businessCode=declare" idField="id" fit="true" queryMode="group" pagination="false" onDblClick="dblDetail">
