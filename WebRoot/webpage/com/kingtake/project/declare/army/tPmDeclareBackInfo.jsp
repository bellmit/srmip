...
<div style="height:1000px;">
      ...
      <table style="width: 865px;margin: auto;" cellpadding="0" cellspacing="0" border="0" >
          <tr>
            ...
            <td width="25%" bgcolor="#E5EFFF" align="right">
             ...
             <%--  <c:if test="${research.bpmStatus eq 1 && read eq 0 }">
                <a id="commitBtn" class="easyui-linkbutton" plain="true" style="border: solid 1px;" title="提交流程" onclick="startProcess('t_b_pm_declare_back');">提交流程</a>
              </c:if>
		...
		<t:formvalid formid="baseInfo" dialog="true" usePlugin="password" layout="table"
			...
			<table style="width: 865px; background-color: white; margin: 0 auto; position: relative;" 
		...
		<c:if test="${read == '0' }">
			<div id="abatePayTool" style="height:auto">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton" 
					...
					onclick="update('编辑','tPmAbatePayfirstController.do?goAddUpdate', 
						'abatePay', 620, 300)">编辑</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" 
					data-options="iconCls:'icon-search',plain:true" 
					onclick="detail('查看','tPmAbatePayfirstController.do?goAddUpdate', 
