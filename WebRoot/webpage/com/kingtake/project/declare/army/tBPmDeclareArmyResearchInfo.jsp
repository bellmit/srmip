    ...
    <div title="${research.projectName }：申报书基本信息">
      <div style="padding: 5px 0; background-color: #f4f4f4;">
          ...
          <tr>
            ...
            <td width="25%" bgcolor="#E5EFFF" align="right">
              ...
              <%-- <c:if test="${research.bpmStatus eq 1 && read eq 0 }">
                <a id="commitBtn" class="easyui-linkbutton" plain="true" style="border: solid 1px;" onclick="startProcess('t_b_pm_declare_army_research');">提交流程</a>
              </c:if>
              <c:if test="${research.bpmStatus ne 1}">
                <a id="viewBtn" class="easyui-linkbutton" plain="true" style="border: solid 1px;" onclick="viewHistory('${research.processInstId }');">查看流程</a>
              </c:if> --%>
            </td>
          </tr>
        </table>
        <t:formvalid formid="baseInfo" dialog="true" usePlugin="password" layout="table" tiptype="showValidMsg" action="tBPmDeclareArmyResearchController.do?doUpdate" callback="@Override saveCallback">
          ...
          <table style="width: 865px; background-color: white; margin: 0 auto; position: relative;" cellpadding="0" cellspacing="1" class="formtable">
            <tr>
              <td align="right">
                <label class="Validform_label">项目编号:</label>
              </td>
              <td class="value">
                <input id="projectNo" name="projectNo" value="${research.projectNo }" style="width: 150px;" type="text" class="inputxt" readonly="readonly" />
              ...
              <td class="value">
                <t:codeTypeSelect name="projectCategory" type="select" codeType="1" code="JNKYSBSXMLB" id="projectCategory" defaultVal="${research.projectCategory }" extendParam="{'style':'width:156px;','datatype':'*'}" labelText="请选择"></t:codeTypeSelect>
                <span class="Validform_checktip"></span>
            ...
            <td align="right">
              ...
              <td class="value" colspan="3">
                ...
                <input id="projectName" name="projectName" value="${research.projectName }" style="width: 620px;" type="text" class="inputxt" readonly="readonly" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <option value="3" <c:if test="${research.projectGroup eq '3' }">selected="selected"</c:if>>3</option>
                ...
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">项目批次</label>
              </td>
              <td align="right">
              ...
              <td class="value" >
                ...
                <input value="${research.projectType.projectTypeName }" type="text" class="inputxt" readonly="readonly" style="width: 150px;" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value">
                <input id="reportDepartId" name="reportDepartId" type="hidden" value="${research.reportDepartId }" />
                <input id="reportDepartName" name="reportDepartName" type="hidden" value="${research.reportDepartName }" />
                <t:departComboTree id="reportDepart" idInput="reportDepartId" nameInput="reportDepartName" lazy="false" value="${research.reportDepartId}" width="156"></t:departComboTree>
                <span class="Validform_checktip"></span>
              ...
              <td class="value">
                <t:codeTypeSelect name="projectGrade" type="select" codeType="1" code="XMJB" id="projectGrade" defaultVal="${research.projectGrade }" labelText="请选择"></t:codeTypeSelect>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">项目级别</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value">
                <t:codeTypeSelect name="projectProperties" type="select" codeType="1" code="XMXZ" id="projectProperties" defaultVal="${research.projectProperties }" labelText="请选择"></t:codeTypeSelect>
                <span class="Validform_checktip"></span>
              ...
              <td class="value">
                <t:codeTypeSelect name="superiorDepartname" type="select" codeType="1" code="SSBM" id="superiorDepartname" defaultVal="${research.superiorDepartname }"></t:codeTypeSelect>
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value">
                <input id="branchDepartName" name="branchDepartName" type="hidden" value="${research.branchDepartName }" />
                <t:codeTypeSelect name="branchDepartId" type="select" codeType="1" code="FGBM" id="branchDepartId" defaultVal="${research.branchDepartId }"></t:codeTypeSelect>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">业务分管机关</label>
              </td>
              ...
              <td class="value">
                <input id="completeDepartName" name="completeDepartName" value="${research.completeDepartName }" style="width: 150px;" type="text" class="inputxt" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              <td align="right">
                <label class="Validform_label">合作单位:</label>
              </td>
              <td class="value" colspan="3">
                <input id="cooperationDepartname" name="cooperationDepartname" value="${research.cooperationDepartname }" style="width: 620px;" type="text" class="inputxt" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              <td align="right">
                <label class="Validform_label">申报日期:</label>
                <font color="red">*</font>
              </td>
              <td class="value">
                <input id="applyTime" name="applyTime" style="width: 150px;" datatype="date"
                  ...
                  <c:if test="${!empty research.applyTime}">value="<fmt:formatDate value='${research.applyTime}' pattern='yyyy-MM-dd'/>"</c:if> type="text" class="Wdate" onClick="WdatePicker()" />
                <span class="Validform_checktip"></span>
              ...
              <td class="value">
                <input id="projectCycle" name="projectCycle" type="text" datatype="*1-5" style="width: 150px;" value="${research.projectCycle }" class="inputxt" />
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">项目周期（年）</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value">
                <input id="projectManagerId" name="projectManagerId" type="hidden" value="${research.projectManagerId }" />
                <input id="projectManagerName" name="projectManagerName" class="inputtxt" style="width: 120px;" value="${research.projectManagerName }" readonly="readonly" />
                <c:if test="${read == '0' }">
              ...
              <td class="value" colspan="3">
                <input id="contactIdNo" name="contactIdNo" value="${research.contactIdNo }" style="width: 150px;" type="text" class="inputxt" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value">
                <input id="contactFixPhone" name="contactFixPhone" datatype="byterange" max="30" min="1" value="${research.contactFixPhone }" style="width: 150px;" type="text" class="inputxt" />
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">固定电话</label>
              </td>
              <td align="right">
                <label class="Validform_label">联系电话:<font color="red">*</font></label>
              </td>
              <td class="value">
                <input id="contactPhone" name="contactPhone" value="${research.contactPhone }" style="width: 150px;" type="text" class="inputxt" datatype="*" ignore="ignore" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value" colspan="3">
                <input id="address" name="address" value="${research.address }" type="text" class="inputxt" style="width: 620px;" maxlength="75" datatype="*" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              <td align="right">
                <label class="Validform_label">邮政编码:</label>
              </td>
              <td class="value">
                <input id="postCode" name="postCode" value="${research.postCode }" type="text" style="width: 150px;" class="easyui-numberbox inputxt" data-options="min:0, max:999999" />
                <span class="Validform_checktip"></span>
              ...
              <td class="value">
                ...
                <input id="bpmStatus" name="bpmStatus" value="${research.bpmStatus }" type="hidden" class="inputxt" />
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value" colspan="3">
                <textarea id="declareKey" name="declareKey" type="text" datatype="*1-250" style="width: 510px; height: 100px;" class="inputxt">${research.declareKey }</textarea>
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value" colspan="3">
                <textarea id="projectSummary" name="projectSummary" maxlength="150" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectSummary }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">项目简介（150字以内）</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="researchAim" name="researchAim" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.researchAim }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">研究目的</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="researchContent" name="researchContent" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.researchContent }</textarea>
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value" colspan="3">
                <textarea id="researchAnalyse" name="researchAnalyse" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.researchAnalyse }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">初步方案和可行性分析</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="projectSchedule" name="projectSchedule" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectSchedule }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">进度安排</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="projectResult" name="projectResult" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectResult }</textarea>
                <span class="Validform_checktip"></span>
            ...
            <tr>
              ...
              <td class="value" colspan="3">
                <textarea id="projectCheck" name="projectCheck" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectCheck }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">主要考核指标</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="projectExtendBenefit" name="projectExtendBenefit" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectExtendBenefit }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">推广应用前景及效益分析</label>
              </td>
            </tr>
            <tr>
              <td align="right">
              ...
              <td class="value" colspan="3">
                <textarea id="projectBaseCondition" name="projectBaseCondition" maxlength="200" datatype="*" style="width: 510px; height: 100px;" class="inputxt">${research.projectBaseCondition }</textarea>
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">已有研究基础和保障条件</label>
              </td>
            </tr>
            <tr>
              <td align="right">
