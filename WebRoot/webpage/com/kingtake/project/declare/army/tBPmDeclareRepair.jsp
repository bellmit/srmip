...
<div class="easyui-accordion" data-options="fit:true">
	<div title="${research.projectName }：申报书基本信息<a href='#' onclick=toastrMsg('repairDeclare') style='color: red'>(查看说明)</a>" style="overflow:auto;" data-options="tools:'#tb'">
      <div id="tb">
        <c:if test="${read == '0' }">
          <a id="saveBtn" class="icon-save"  title="保存申报书" onclick="saveBaseInfo();"></a>
        </c:if>
        <c:if test="${!empty research.id && research.bpmStatus eq 1 && read eq 0 }">
          <a id="commitBtn" class="icon-ok" title="提交流程" onclick="startProcess('t_b_pm_declare_repair');"></a>
        </c:if>
        <c:if test="${research.bpmStatus eq '5' && read eq '0' }">
          <a href="#" class="icon-ok" title="修改完成后重新提交流程" onclick="compeleteProcess('repair');"></a>
          <a href="#" class="icon-search" title="查看历史" onclick="viewRemark();"></a>
        </c:if>
        ...
        <c:if test="${research.bpmStatus ne '1' and research.bpmStatus ne '5' and research.planStatus ne '2' and research.bpmStatus ne '6' and opt ne 'audit'}">
          <a id="viewBtn" class="icon-search" title="查看流程" onclick="viewHistory('${research.processInstId }');"></a>
        </c:if>
      </div>
      <div style="padding: 5px 0; background-color: #f4f4f4;">
		<t:formvalid formid="baseInfo" dialog="true" usePlugin="password" layout="table"
				action="tBPmDeclareRepairController.do?doUpdate" tiptype="showValidMsg" callback="@Override saveCallback">
			...
			<table style="width: 1000px; background-color: white; margin: 0 auto; position: relative;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					<td align="right">
                ...
                <tr>
					...
					<td align="right">
                        <label class="Validform_label">项目类别:<font color="red">*</font></label>
                    </td>
                    <td class="value">
                        <t:codeTypeSelect id="projectCategory" name="projectCategory" type="select" codeType="1" 
                        	code="WXSBSXMLB" defaultVal="${research.projectCategory }">
                        </t:codeTypeSelect>
                        <span class="Validform_checktip"></span>
					...
					<td class="value">
						<input id="projectManagerId" name="projectManagerId" type="hidden" value="${research.projectManagerId }" /> 
				     	<input id="projectManagerName" name="projectManagerName" type="text" style="width: 150px" 
				     		class="inputxt" value="${research.projectManagerName }" />
				     	<c:if test="${read == '0'}">
							<t:chooseUser icon="icon-search" title="人员列表" isclear="true" mode="single" idInput="projectManagerId"
								textname="id,realName"  inputTextname="projectManagerId,projectManagerName"></t:chooseUser>
						</c:if>
						<span class="Validform_checktip"></span>
				...
				<tr>
					<td align="right">
						<label class="Validform_label">填报单位:<font color="red">*</font></label>
					</td>
					<td class="value">
						<input id="applyDeptId" name="applyDeptId" type="hidden" value="${research.applyDeptId }" /> 
						<input id="applyDeptName" name="applyDeptName" type="hidden" value="${research.applyDeptName }" 
							datatype="*" />
						<t:departComboTree id="applyDept" idInput="applyDeptId" nameInput="applyDeptName" 
							lazy="true" value="${research.applyDeptName}" width="156"></t:departComboTree> 
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">填报单位</label>
					</td>
					<td align="right">
                    ...
                    <td class="value">
                        ...
                        <span class="Validform_checktip"></span>
                        <label class="Validform_label" style="display: none;">填报日期</label>
                    </td>
					<td align="right">
				...
				<tr>
					<td align="right">
						<label class="Validform_label">项目简介<br/>(150字以内):<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="projectIntroduce" name="projectIntroduce" maxlength="150" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.projectIntroduce }</textarea>
						<span class="Validform_checktip"></span>
				...
				<tr>
					<td align="right">
						<label class="Validform_label">军事需求:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="militaryDemand" name="militaryDemand" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.militaryDemand }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">军事需求</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">应用前景:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="applicationProspect" name="applicationProspect" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.applicationProspect }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">应用前景</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">技术途径<br/>研究方案:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="technicalResearch" name="technicalResearch" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.technicalResearch }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">技术途径/研究方案</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">先进程度:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="advancedDegree" name="advancedDegree" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.advancedDegree }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">先进程度</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">技术指标:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="technicalIndex" name="technicalIndex" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.technicalIndex }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">技术指标</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">进度安排:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="scheduling" name="scheduling" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.scheduling }</textarea>
						<span class="Validform_checktip"></span>
				...
				<tr>
					<td align="right">
						<label class="Validform_label">风险评估:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="riskAssessment" name="riskAssessment" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.riskAssessment }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">风险评估</label>
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					<td align="right">
						<label class="Validform_label">承研能力<br/>设施条件:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="bearingFacility" name="bearingFacility" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.bearingFacility }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">承研能力/设施条件</label>
					</td>
				</tr>
				<tr>
					<td align="right">
						<label class="Validform_label">以往承担<br/>装备维修科学研究<br/>与改革项目<br/>的推广应用情况:<font color="red">*</font></label>
					</td>
					<td class="value" colspan="5">
				     	<textarea id="pastSituation" name="pastSituation" maxlength="200" datatype="*"
				     		style="width: 710px; height:100px;" class="inputxt">${research.pastSituation }</textarea>
						<span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">以往承担装备维修科学研究与改革项目的推广应用情况</label>
					</td>
				</tr>
        <tr>
            <td align="right">
...
$(document).ready(function(){
	if($("#read").val() == '1'){
		...
		$("#applyDept").combotree({disabled:true});
	}
});
