...
<t:datagrid fitColumns="true" name="historyTaskList" queryMode="group" title="历史任务列表" actionUrl="tPmDeclareController.do?taskHistoryList&businessCode=${businessCode}" idField="id">
 <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
 <t:dgCol title="流程编号" field="procDefId" width="80" hidden="true" ></t:dgCol>
 <t:dgCol title="流程" field="prodef_name" width="150" ></t:dgCol>
 ...
 <t:dgCol title="code" field="businessCode" hidden="true" width="100"></t:dgCol>
 ...
 <t:dgFunOpt funname="goProcessHisTab(proInsl_procInstId,prodef_name,businessCode)" title="历史"></t:dgFunOpt>
 </t:datagrid>
