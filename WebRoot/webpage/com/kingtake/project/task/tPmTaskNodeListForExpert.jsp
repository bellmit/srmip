...
<table border="1" style="border-style: dotted; border-color: #A8D7E9;" cellpadding="2" cellspacing="0" id="tPmTaskNode_table">
	<tr bgcolor="#E6E6E6">
		<td align="center" bgcolor="#EEEEEE">序号</td>
    	  <td align="left" bgcolor="#EEEEEE">计划时间</td>
    	  <td align="left" bgcolor="#EEEEEE">完成时间</td>
          ...
          <td align="left" class="quality" bgcolor="#EEEEEE">查看</td>
	</tr>
	...
	<c:if test="${fn:length(tPmTaskNodeList)  > 0 }">
        ...
        <tr>
          ...
          <c:if test="${poVal.planCheckFlag  eq 'N' }">
            <td align="left" >
                <input name="tPmTaskNodeList[${stuts.index }].planCheckFlag" maxlength="1" type="checkbox"
          ...
          <c:if test="${poVal.qualityCheckFlag  eq 'Y' }">
            <td align="left" >
                <input name="tPmTaskNodeList[${stuts.index }].qualityCheckFlag" maxlength="1" type="checkbox" 
                  class="inputxt quality" style="width: 50px;" value="${poVal.qualityCheckFlag }" checked="checked" onclick="setFlag(name,'${poVal.id}','2')"
                  title="审核人：${poVal.qualityCheckUsername }，审核时间：<fmt:formatDate value='${poVal.qualityCheckTime}' pattern='yyyy-MM-dd HH:mm:ss' />"> 
                <label class="Validform_label" style="display: none;">质量办检查</label>
            </td>
          </c:if>
          <c:if test="${poVal.qualityCheckFlag  eq  'N' }">
            <td align="left" >
                <input name="tPmTaskNodeList[${stuts.index }].qualityCheckFlag" maxlength="1" type="checkbox" 
                  class="inputxt quality" style="width: 50px;" value="${poVal.qualityCheckFlag }" onclick="setFlag(name,'${poVal.id}','2')"> 
                <label class="Validform_label" style="display: none;">质量办检查</label>
            </td>
          </c:if>
          <td align="left" style="width:100px;">
