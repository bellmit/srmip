	...
	<div region="center" style="padding:1px;">
		<t:datagrid name="tPmProjectFundsApprList" checkbox="true" fitColumns="true" pagination="false"
			...
			<t:dgCol title="编制时间" field="createDate" formatter="yyyy-MM-dd" query="true"
				queryMode="group" width="120" align="center"></t:dgCol>
			<t:dgCol title="总经费" field="allFee" queryMode="group" width="120" align="right" 
				extendParams="formatter:formatCurrency,"></t:dgCol>
			<c:if test="${planContractFlag != PLANFLAG}">
			<t:dgCol title="到账经费" field="accountFunds" queryMode="group" width="120" align="right" 
				extendParams="formatter:formatCurrency,"></t:dgCol>
			</c:if>
			<c:if test="${planContractFlag == PLANFLAG}">
			<t:dgCol title="年度经费" field="yearFundsPlan" queryMode="group" width="120" align="right" 
				extendParams="formatter:formatCurrency,"></t:dgCol>
			</c:if>
			<t:dgCol title="归垫经费" field="reinFundsPlan" queryMode="group" width="120" align="right" 
				extendParams="formatter:formatCurrency,"></t:dgCol>
			<t:dgCol title="预算类型" field="fundsType" width="80" codeDict="1,FUNSTYPE" align="center"></t:dgCol>
			<t:dgCol title="是否预算变更" field="changeFlag" width="120" codeDict="0,SFBZ" align="center"></t:dgCol>
			<t:dgCol title="审核状态" field="finishFlag" codeDict="1,SPZT" queryMode="group" width="80" align="center"></t:dgCol>
			
			<t:dgCol title="操作" field="opt" width="250" frozenColumn="true"></t:dgCol>
			<t:dgFunOpt funname="goFundsTab(id, changeFlag)" title="预算明细"></t:dgFunOpt>
