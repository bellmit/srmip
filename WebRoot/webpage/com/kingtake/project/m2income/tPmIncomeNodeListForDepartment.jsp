...
<script type="text/javascript" src="webpage/common/util.js"></script>	
	<t:datagrid name="tPmIncomeNodeList" checkbox="false" fitColumns="false" 
		...
		<t:dgCol title="来款时间" field="incomeTime" formatter="yyyy-MM-dd" queryMode="group" query="true" width="90" align="center"></t:dgCol>
		<t:dgCol title="来款金额(元)" field="incomeAmount" align="right" queryMode="group" width="90" extendParams="formatter:formatCurrency,"></t:dgCol>
		...
		<t:dgCol title="创建时间" field="createDate" hidden="true" formatter="yyyy-MM-dd hh:mm:ss"  queryMode="group" width="150" align="center"></t:dgCol>
		...
		<t:dgCol title="审核时间" field="auditTime" hidden="true" formatter="yyyy-MM-dd hh:mm:ss"  queryMode="group" width="150"></t:dgCol>
		<t:dgCol title="修改人" field="updateBy" hidden="true" queryMode="group" width="120"></t:dgCol>
		<t:dgCol title="修改人姓名" field="updateName" hidden="true" queryMode="group" width="120"></t:dgCol>
		<t:dgCol title="修改时间" field="updateDate" hidden="true" formatter="yyyy-MM-dd"  queryMode="group" width="90"></t:dgCol>
		<t:dgCol title="来款节点审核" field="audit" width="100" extendParams="formatter:optFormatter,"></t:dgCol>
		<t:dgToolBar title="查看" icon="icon-search" url="tPmIncomeNodeController.do?goUpdate" funname="detail" width="550" height="400"></t:dgToolBar>
	</t:datagrid>
</div>
