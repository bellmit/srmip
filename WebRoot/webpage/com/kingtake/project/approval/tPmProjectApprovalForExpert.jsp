...
<body>
  ...
  <div id="memberData">
<%--   <iframe id="dataIframe" src="tPmProjectMemberController.do?tPmProjectMemberListDetail&projectId=${projectId}" width="100%" height="400"  scrolling="auto" frameborder="0"></iframe> --%>
  <table class="mytable"  cellpadding="0" cellspacing="0" >
  <tr height="30">
  <th>姓名</th><th>单位</th><th>职称</th><th>分工</th>
  </tr>
  <c:forEach items="${memberList}" var="m">
  <tr>
  	<td class="value" align="center">${m.name}</td>
  	<td class="value" align="center">${m.superUnitName}</td>
  	<td class="value" align="center"><t:convert codeType="0" code="PROFESSIONAL" value="${m.position}"></t:convert></td>
  	<td class="value" align="center">${m.taskDivide}</td>
  </tr>
  </c:forEach>
  </table>
  </div>
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
    ...
    <input id="tpId" name="tpId" type="hidden" value="${tPmProjectApprovalPage.project.id}">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable">
      <tr>
        ...
        <td style="width: 75%" class="value"><input id="suggestGrade" name="suggestGrade" type="text"
          style="width: 150px" class="inputxt" datatype="*2-20" value='${tPmProjectApprovalPage.suggestGrade}'>
      ...
      <tr>
        ...
        <td class="value"><input id="suggestUnit" name="suggestUnit" type="text" style="width: 150px"
          class="inputxt" datatype="*2-60" value='${tPmProjectApprovalPage.suggestUnit}'> <span
      ...
      <tr>
        ...
        <td class="value"><input id="studyTime" name="studyTime" type="text" datatype="*2-50" style="width: 150px"
      ...
      <tr>
        ...
        <td colspan="3" class="value">
          ...
          <t:upload name="fiels" id="file_upload"
            extend="*.doc;*.docx;*.txt;*.ppt;*.xls;*.xlsx;*.html;*.htm;*.pdf;" buttonText="添加文件" formData="bid"
