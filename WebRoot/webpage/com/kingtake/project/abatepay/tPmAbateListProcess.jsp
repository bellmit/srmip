...
<div class="easyui-layout" fit="true" >
  ...
  <%--  <t:dgCol title="创建人"  field="createBy"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" exp="bpmStatus#eq#1" url="tPmAbateController.do?doDel&id={id}" />
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="tPmAbateController.do?goAddUpdate" funname="detail" width="720" height="480"></t:dgToolBar>
...
function goUpdate(id,index) {
    createwindow('编辑减免信息', 'tPmAbateController.do?goAddUpdate&id=' + id, '720px', '480px');
}
...
function submitProcess(index,nextUser) {
    ...
    //流程对应表单URL
    var formUrl = 'tPmAbateController.do?goAudit&opt=audit';
