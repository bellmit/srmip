...
<div id="tempSearchColums" style="display: none">
    <div name="searchColums">
        ...
        <select id="isFinish" name="isFinish" type="select" style="width: 80px; height:23px; vertical-align: middle;">
...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tPmProjectList" checkbox="true" fitColumns="false" title="项目列表" actionUrl="tPmProjectController.do?datagridState&approvalStatus=1" sortName="createDate" sortOrder="desc"
      idField="id" fit="true" queryMode="group" onDblClick="view" pageSize="20" pageList="[20,40,60]" view="scrollview" >
        ...
        <t:dgCol title="是否出校检验"  field="checkapprovalFlag" hidden="true"  width="60"></t:dgCol>             
...
<%--         <t:dgFunOpt funname="editProject(id)" title="编辑"></t:dgFunOpt> --%>
		<t:dgFunOpt exp="checkapprovalFlag#ne#1" funname="checkApply(id)" title="添加出校检验"></t:dgFunOpt>
		<t:dgFunOpt exp="checkapprovalFlag#eq#1" funname="checkApply(id)" title="查看出校检验"></t:dgFunOpt>
      </t:datagrid>
  </div>
 </div>
...
$(document).ready(function(){
  ...
  function checkApply(id){
	$.dialog({
		content: 'url:tPmCheckApplyController.do?goCheckApply&projectId=' + id,
		lock : true,
