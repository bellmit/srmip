...
<html>
 <head>
  ...
  function checkAmount(){
	  ...
	  var incomeAmount = Number($('#incomeAmount').val());
	  if(minAmount>incomeAmount){
		  $.Showmsg("到账金额不能小于已分配金额!");
		  return false;
	  }
	  return true;
  }
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPmIncomeController.do?doUpdate" beforeSubmit="checkAmount" tiptype="1">
					...
					<input id="minAmount" name="minAmount" type="hidden" value="${minAmount}"> 
