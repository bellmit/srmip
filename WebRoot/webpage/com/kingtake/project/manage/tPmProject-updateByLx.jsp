...
<!--   <div> -->
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
      <tr>
        ...
        <td width="5%" bgcolor="#E5EFFF"><input id="applying" value="${applying }" type="hidden" /> <c:if test="${tPmProjectPage.approvalStatus ne '1' }">
        ...
        <div align="left">
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <td class="value"><input id="accordingNum" name="accordingNum" type="text" style="width: 100px" class="inputxt"  value="${tPmProjectPage.accordingNum}"> <c:if
            ...
            <tr>
              ...
              <td class="value"><input id="projectManager" name="projectManager" type="text" ignore="ignore" datatype="s2-16" style="width: 160px" class="inputxt" datatype="s2-16"
                value='${tPmProjectPage.projectManager}' > <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">负责人</label></td>
              ...
              <td class="value"><input type="text" style="width: 160px" class="inputxt"  value='${projectStatusMap[tPmProjectPage.projectStatus]}'> <input
            ...
            <tr>
              ...
              <td class="value">
              <input id="accountingCode" name="accountingCode" type="text" datatype="s2-250" ignore="ignore" style="width: 160px" class="inputxt"
                value='${tPmProjectPage.accountingCode}'> 
        ...
        <div>
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="formtable">
          	<tr>
		            ...
		            <td class="value">
		            	<input id="xmml" name='xmml' type="text"  class="inputxt" datatype="*" value="${tPmProjectPage.xmml}" style='width: 120px;' />
		            ...
		            <td class="value">
		            	<%-- <input type="text" id="jflx" readonly style="width: 200px" class="inputxt" value="${tPmProjectPage.xmlb.jflxStr}" datatype="*"> --%>
...
<%--                 value='${tPmProjectPage.subType}'> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">子类型</label></td> --%>
            ...
            <tr id="parentProjectLabel">
              ...
              <td class="value" colspan="3"><input id="parentProjectId" name="parentPmProject.id" type="hidden" value="${tPmProjectPage.parentPmProject.id}"> <input id="parentProjectName"
                type="text" style="width: 330px" class="inputxt" value='${tPmProjectPage.parentProjectName}' > <c:if
                  test="${tPmProjectPage.approvalStatus ne '1' }">
...
<!--               class="Validform_label" style="display: none;">科目代码</label></td> -->
              ...
              <label class="Validform_label" style="display: none;">项目来源</label>
               ...
               <td align="right"><label class="Validform_label"> 配套情况: </label></td>
            	...
            	<td align="right"><label class="Validform_label"> 项目名称: </label></td>
	            	<td class="value" colspan="3"><input id="projectId" name="glxm.id" type="hidden" value="${tPmProjectPage.glxm.id}"> 
						<input id="projectName2" type="text" style="width: 250px" class="inputxt" readonly="readonly" value="${tPmProjectPage.glxm.projectName}"> 
						<t:choose url="tPmProjectController.do?projectSelect&plan=1" width="1000px" height="460px" left="10%" top="10%"
						name="projectList" icon="icon-search" title="项目列表" textname="id,projectName" inputTextname="projectId,projectName2" isclear="true"></t:choose>
						<span class="Validform_checktip"></span>
            ...
            <td class="value">
              <input id="planYear" name="planYear" type="text" ignore="ignore" datatype="*" style="width: 100px"  value="${tPmProjectPage.planYear}" class="Wdate"
...
<!--   </div> -->
  <!-- -------------------项目组成员-------------华丽的分割线---------------------------------- -->
  <div class="easyui-layout" style="margin-top: 10px; height: 500px; width: 1300px">
