...
<!--   <div> -->
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td align="center" style="background-color: #4782d8;padding:3px;color:#fff;"><b>${tPmProjectPage.projectName}-项目基本信息表</b></td>
        ...
        <div align="left">
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <td class="value"><input id="cxm" name="cxm" type="text" ignore="ignore" datatype="s2-20" style="width: 160px" class="inputxt" validType="T_PM_PROJECT,PROJECT_NO,ID"
                value='${tPmProjectPage.cxm}' readonly="readonly"> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">申报编号</label></td>
              <td align="right" width="105px"><label class="Validform_label"> 会计编码: </label></td>
              <td class="value"><input id="accountingCode" name="accountingCode" type="text" datatype="s2-250" ignore="ignore" style="width: 160px" class="inputxt" readonly="readonly"
              ...
              <td class="value"><input id="accordingNum" name="accordingNum" type="text" style="width: 100px" class="inputxt" readonly="readonly" value="${tPmProjectPage.accordingNum}"> <c:if
                ...
                </c:if> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">关键词</label></td>
            </tr>
            <tr>
              ...
              <td class="value"><input id="projectManager" name="projectManager" type="text" ignore="ignore" datatype="s2-16" style="width: 160px" class="inputxt" datatype="s2-16"
                value='${tPmProjectPage.projectManager}' readonly="readonly"> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">项目组长</label></td>
            ...
            <tr>
              ...
              <td class="value"><t:departComboTree name="" id="dutyDepartDepartname" idInput="dutyDepartId" lazy="false" value="${tPmProjectPage.dutyDepart.departname}" width="165"></t:departComboTree>
              ...
              <td class="value"><input id="managerPhone" name="managerPhone" type="text" style="width: 150px" class="inputxt" value='${tPmProjectPage.managerPhone}' datatype="*1-30"> <span
            ...
            <tr>
              ...
              <td class="value"><input id="contact" name="contact" type="text" datatype="s2-16" style="width: 150px" class="inputxt" value='${tPmProjectPage.contact}'><img alt="“联系人”与“联系人电话”为“科研助理人”与“科研助理人电话”" title="“联系人”与“联系人电话”为“科研助理人”与“科研助理人电话”" src="plug-in\easyui1.4.2\themes\icons\tip.png"> <span
            ...
            <tr>
              ...
              <td colspan="5" class="value"><textarea id="projectAbstract" name="projectAbstract" type="text" datatype="*" style="width: 97%; height: 80px;" class="inputxt">${tPmProjectPage.projectAbstract}</textarea>
      ...
      <fieldset style="border-style: solid none none none; border-top: 3px double #CACACA;">
        ...
        <div>
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="formtable">
          	<tr>
            		<td align="right" width="130px;"><label class="Validform_label"> 项目类别: </label><font color="red">*</font></td>
		            <td class="value">
		   ...
		   <%-- 	<input id="jflx" value="${tPmProjectPage.jflx.jflxmc}" style='width: 150px;'>
	          ...
	          <tr>
		            ...
		            <td class="value">
		            	...
		            	<input id="jjfjsfsId" name="xmlb.id" type="hidden" datatype="*" value="${tPmProjectPage.jjfjsfs}">
		            	<span class="Validform_checktip"></span> 
		            ...
		            <td class="value">
		            	...
		            	<input id="yslxId" name="xmlb.id" type="hidden" datatype="*" value="${tPmProjectPage.yslx}">
		            	<span class="Validform_checktip"></span> 
		            	<label class="Validform_label" style="display: none;">预算类型</label>
		            </td>
		            <td align="right"><label class="Validform_label"> 大学比例: </label></td>
		            <td class="value">
		            	<input style='width: 130px;' id="outsideNo" name="outsideNo" type="text" class="inputxt" value='${tPmProjectPage.dxbl}'> 
		            	<span class="Validform_checktip"></span> 
	          ...
	          <tr>
		            ...
		            <td class="value">
		            	<input style='width: 130px;' id="outsideNo" name="outsideNo" type="text" class="inputxt" value='${tPmProjectPage.zrdwbl}'> 
		            	<span class="Validform_checktip"></span> 
		            	<label class="Validform_label" style="display: none;">责任单位比例</label>
		            </td>
		            <td align="right"><label class="Validform_label"> 承研单位比例: </label></td>
		            <td class="value">
		            	<input style='width: 130px;' id="outsideNo" name="outsideNo" type="text" class="inputxt" value='${tPmProjectPage.cydwbl}'> 
		            	<span class="Validform_checktip"></span> 
		            	<label class="Validform_label" style="display: none;">承研单位比例</label>
		            </td>
		            <td align="right"><label class="Validform_label"> 项目组比例: </label></td>
		            <td class="value">
		            	<input style='width: 130px;' id="outsideNo" name="outsideNo" type="text" class="inputxt" value='${tPmProjectPage.xmzbl}'> 
		            	<span class="Validform_checktip"></span> 
...
<%--                 value='${tPmProjectPage.subType}'> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">子类型</label></td> --%>
            ...
            <tr id="parentProjectLabel">
              ...
              <td class="value" colspan="3"><input id="parentProjectId" name="parentPmProject.id" type="hidden" value="${tPmProjectPage.parentPmProject.id}"> <input id="parentProjectName"
                type="text" style="width: 330px" class="inputxt" value='${tPmProjectPage.parentProjectName}' readonly="readonly"> <c:if
                  test="${tPmProjectPage.approvalStatus ne '1' }">
           ...
           --%> 
              ...
              <td class="value"><input style='width: 130px;' id="feeSingleColumn" name="feeSingleColumn" type="text" class="inputxt" value='${tPmProjectPage.feeSingleColumn}'> <span
...
<!--               class="Validform_label" style="display: none;">科目代码</label></td> -->
              ...
              <td class="value"><t:codeTypeSelect name="manageDepartCode" type="select" codeType="1" code="FGBM" id="manageDepartCode" labelText="请选择" extendParam="{style:'width:145px;'}"
            ...
            <tr>
              ...
              <td class="value"><input style='width: 120px;' id="planContractName" name="planContractName" type="text" datatype="byterange" max="1000" min="0" class="inputxt" value='${tPmProjectPage.planContractName}'><img alt="甲方合同名称" title="甲方合同名称" src="plug-in\easyui1.4.2\themes\icons\tip.png">
            ...
            <tr>
              ...
              <td class="value"><input style='width: 130px;' id="planContractRefNo" name="planContractRefNo" type="text" datatype="byterange" max="1000" min="0" class="inputxt" value='${tPmProjectPage.planContractRefNo}'> <span
              ...
              <td class="value"><input style='width: 130px;' id="outsideNo" name="outsideNo" type="text" class="inputxt" value='${tPmProjectPage.outsideNo}'> <span
              ...
              <td align="right"><label class="Validform_label"> 舰艇舷号: </label></td>
            	<td class="value"><input style='width: 130px;' id="shipNumber" name="shipNumber" type="text" datatype="*0-5"
              		value="${tPmProjectPage.shipNumber}"><span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">舰艇舷号</label></td>
            </tr>
            <tr>
            <%-- <td align="right">
              <label class="Validform_label"> 项目来源: </label>
            ...
            <td class="value">
              ...
              <td align="right"><label class="Validform_label"> 型号背景: </label></td>
          		<td class="value">
                	...
                	<select id="modelBackground" class="easyui-combobox" name="modelBackground" style='width: 120px;'>   
              ...
              <td class="value"><input style='width: 130px;' id="sourceUnit" name="sourceUnit" type="text" datatype="byterange" max="2000" min="1" class="inputxt" value='${tPmProjectPage.sourceUnit}'> <span
