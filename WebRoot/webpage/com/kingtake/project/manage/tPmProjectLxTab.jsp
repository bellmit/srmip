...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tPmProjectList" fitColumns="false" title="项目列表" onDblClick="dblclick" pageSize="20" pageList="[20,40,60]"
  	actionUrl="tPmProjectController.do?datagridState&approvalStatus=0&lxStatus=1" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc" view="scrollview">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="group"  width="100"></t:dgCol>
   <t:dgCol title="立项编号"  field="projectNo" queryMode="group"  width="150"></t:dgCol>
...
function ImportSendXls() {
    openuploadwin('Excel导入', 'tPmProjectController.do?upload&lxStatus=1', "tPmProjectList");
}
