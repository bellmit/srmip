...
<body>
  <div>
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td align="center" bgcolor="#E5EFFF"><b>${tPmProjectPage.projectName}-项目申报信息表</b></td>
        <td width="5%" bgcolor="#E5EFFF"><input id="applying" value="${applying }" type="hidden" /> <input id="saveBtn" type="button" value="保存项目申报信息"></td>
      </tr>
    </table>
        ...
        <div align="left">
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <td class="value" colspan="3"><input id="projectName" name="projectName" type="text" datatype="*2-30" style="width: 450px" class="inputxt" value='${tPmProjectPage.projectName}'
            ...
            <tr>
              ...
              <td colspan="5" class="value"><textarea id="projectAbstract" name="projectAbstract" type="text" datatype="*" style="width: 98%; height: 80px;" class="inputxt">${tPmProjectPage.projectAbstract}</textarea>
        ...
        <div>
          <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="formtable">
            ...
            <tr>
              ...
              <td class="value" colspan="3"><input id="planContractName" name="planContractName" type="text" datatype="byterange" max="1000" min="0" style="width: 330px" class="inputxt" value='${tPmProjectPage.planContractName}'>
            ...
            <tr>
              ...
              <td class="value" colspan="4"><input id="sourceUnit" name="sourceUnit" type="text" datatype="byterange" max="2000" min="1" style="width: 430px" class="inputxt" value='${tPmProjectPage.sourceUnit}'> <span
            ...
            <tr>
              ...
              <td class="value" colspan="2"><input type="text" id="officeStaffRealname" readonly style="width: 120px" class="inputxt" value="${officeStaffRealname}"> <input type="hidden"
                id="officeStaff" name="officeStaff" value='${tPmProjectPage.officeStaff}'> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">机关主管参谋</label>
              </td>
              <td align="right"><label class="Validform_label"> 院系主管参谋: </label></td>
              <td class="value" colspan="2"><input type="text" id="departStaffRealname" readonly style="width: 120px" class="inputxt" value='${departStaffRealname}'> <input type="hidden"
                id="departStaff" name="departStaff" value='${tPmProjectPage.departStaff}'> <t:chooseUser icon="icon-search" title="人员列表" isclear="true" mode="single" idInput="departStaff"
                  textname="id,realName" inputTextname="departStaff,departStaffRealname"></t:chooseUser> <span class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">院系主管参谋</label>
              </td>
