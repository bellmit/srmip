...
<SCRIPT type="text/javascript">
  ...
  function initTree(treeId,auditStatus){
	    $("#"+treeId).tree({
	        url:'projectMgrController.do?unApprovalProjectList'+(auditStatus ? "&auditStatus=1" : ""),
        ...
        <td align="right" nowrap>
          <table border="0" cellpadding="0" cellspacing="0">
            <tr style="height: 25px;" align="right">
              <td style="" colspan="2">
                <div style="background:rgba(119,205,255,0.4); float: right;">
                  ...
                  <div style="float: left; margin-left: 18px;">
                    <a id="btn" href="#" class="easyui-linkbutton" title="返回" data-options="iconCls:'icon-no',plain:true" onclick="closeWebPage()" onmouseover="mouseover()" onmouseout="mouseout()">
            ...
            <tr style="height: 80px;">
              <td colspan="2" style="">
                <span class="shadow" style="word-spacing: 20px; font:40px/30px 'Times New Roman', arial, sans-serif; color: #fff;"> 课 题 组 项 目 管 理 </span>
    ...
    <div id="centerPanel" class="easyui-layout" data-options="fit:true,border:false">
      ...
      <div id="treeTabs" class="easyui-tabs" data-options="tools:'#tab-tools',onSelect:treeTabSelect,fit:true" >
      	...
      	<div title="草稿箱" >
      		<span style="float:right;padding:5px;">
           		<a id="refreshBtn" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true" onclick="initTree('unapprovalTree');" title="刷新项目树" style="vertical-align: top;">刷新</a> 
            </span>
        	<ul id="unapprovalTree" class="easyui-tree" ></ul>
        </div>
        
        
        <div title="待审批">
       		<span style="float:right;padding:5px;">
             	<a id="refreshBtn" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true" onclick="initTree('approvalTree',1);" title="刷新项目树" style="vertical-align: top;">刷新</a> 
            </span>
       	 <ul id="approvalTree" class="easyui-tree"></ul>
        </div> 
      
        <!--  -->
        <div title="已审批"  style="padding: 0px;"  selected>
        <div class="easyui-layout" data-options="fit:true,border:true">
          <div data-options="region:'north'" style="height: 63px; text-align: center; padding-top: 2px; vertical-align: top; overflow: hidden; border-style: solid none solid none">
            <div><input id="search" class="easyui-searchbox" style="height: 26px;width: 190px;" data-options="prompt:'输入项目名称',searcher:doSearch,width:130"></div>
            <span>
          ...
          <div id="swithImg" data-options="region:'south'" style="height: 37px;border-style: solid none none none; padding-top: 2px; text-align: center; ">
            <span>
      ...
      <div region="center" id="centerRegion">
        ...
        <div id="ApprovalDiv" class="easyui-tabs" data-options="fit:true,border:true" >
          ...
          <div  title="项目信息录入及管理" style="overflow-y: hidden; overflow-x: auto;" selected>
        ...
        <div id="maintabs" class="easyui-tabs" data-options="fit:true,border:true,onSelect:selectTab" >
          <!-- 为了控制在浏览器窗口变小时不出现两个纵向滚动条，需要给div加上overflow样式          zhangls    2016-01-21 -->
          <div id="projectInfoDiv" title="项目信息录入及管理" style="overflow-y: hidden; overflow-x: auto;" selected>
            <iframe id="projectInfoFrame" scrolling="no" frameborder="0" style="width: 100%; height: 99.5%;"></iframe>
          </div>
          <div id="projectProcessDiv" title="项目过程管理">
