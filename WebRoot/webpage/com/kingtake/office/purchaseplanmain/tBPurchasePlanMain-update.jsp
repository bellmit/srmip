...
<body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" layout="table" tiptype="1" action="tBPurchasePlanMainController.do?doUpdate" beforeSubmit="setPlanDate();">
    ...
    <table cellpadding="0" cellspacing="1" class="formtable">
      ...
      <tr>
        ...
        <td class="value">
          <input id="dutyDepartName" name="dutyDepartName" type="hidden" datatype="*" value='${tBPurchasePlanMainPage.dutyDepartName}'>
          <t:departComboTree id="ddn" idInput="dutyDepartId" nameInput="dutyDepartName" lazy="false" width="355" value="${tBPurchasePlanMainPage.dutyDepartName}"></t:departComboTree>
          <span class="Validform_checktip"></span>
