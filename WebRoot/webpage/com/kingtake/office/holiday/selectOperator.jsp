...
form{
 ...
 <div align="center" style="vertical-align: middle;margin-top: 60px;">
		<table  cellpadding="0" cellspacing="1" class="formtable">
				...
				<t:chooseUser icon="icon-search" title="人员列表" textname="id,userName,realName,departId" isclear="true" inputTextname="userId,nextUser,realName,departId" idInput="userId" mode="${mode}"></t:chooseUser>
