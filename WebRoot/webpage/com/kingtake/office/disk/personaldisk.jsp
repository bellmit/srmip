...
<div class="easyui-layout" fit="true" >
  ...
  <t:datagrid name="diskList" checkbox="true" fitColumns="true" title="个人网盘列表" 
  		actionUrl="tODiskController.do?datagridForPersonal&uploadType=personal" 
...
function goRecycle(){
    var title="我的回收站";
    var url = "tODiskController.do?goRecycle&uploadType=personal";
