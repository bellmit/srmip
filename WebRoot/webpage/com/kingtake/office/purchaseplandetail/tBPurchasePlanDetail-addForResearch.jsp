...
<script type="text/javascript">
  ...
  function formCallback(data){
		...
		var dialog = W.$.dialog.list['cgjhDialog'];
	    if (dialog == undefined) {
	    	win = frameElement.api.opener;
	    } else {
	    	win = dialog.content;
	    }
      win.loadDetail(data.obj);
...
<body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" layout="table" tiptype="1" action="tBPurchasePlanMainController.do?doForwardDetail" callback="@Override formCallback">
