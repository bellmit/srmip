...
%>
 ...
 <body onload="load()">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password"  layout="table" action="tOApprovalController.do?doNothing" callback="@Override callback" tiptype="1" beforeSubmit="SaveSignature">
...
<%-- 					<input id="undertakeUnitId" name="undertakeUnitId" type="hidden" value="${tOApprovalPage.undertakeUnitId }"> --%>
  ...
  <tr>
    ...
    <div style="float: right;">
                                       ...
                                       <a style="cursor:pointer;" onClick="delUserSignature('1')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'" title="删除批注">删除</a>
                                        ...
                                        <OBJECT name="president" classid="<%=clsId %>" codebase="<%=codeBase %>" width="94%" height="200">
  ...
  <tr>
    <td height="200px" class="title3"><p class="STYLE1">部(院)领导批示:</p>
    <div style="float: right;">
                                       ...
                                       <a style="cursor:pointer;" onClick="delUserSignature('2')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'" title="删除批注">删除</a>
                                        ...
                                        <OBJECT name="departmentLeader" classid="<%=clsId %>" codebase="<%=codeBase %>" width="94%" height="200">
                                          <param name="WebUrl" value="<%=mServerUrl%>">    <!-- WebUrl:系统服务器路径，与服务器交互操作，如打开签章信息 -->
                                          <param name="RecordID" value="${tOApprovalPage.id }">    <!-- RecordID:本文档记录编号 -->
...
<table width="100%" border="0" cellspacing="10" cellpadding="0">
  ...
  <tr>
    <td colspan="3" align="center"><input id="fileNumPrefix" name="fileNumPrefix" type="text" style="width: 50px;border-style: none none solid none;border-color:#54A5D5;border-width: 1px;" class="inputxt" value='${tOApprovalPage.fileNumPrefix}'  readonly="readonly">
				﹝20<input id="approvalYear" name="approvalYear" datatype="*1-2" ignore="ignore" type="text" style="width: 20px;border-style: none none solid none;border-color:#54A5D5;border-width: 1px;" class="inputxt" value='${tOApprovalPage.approvalYear}' readonly="readonly">﹞
				<input id="applicationFileno" name="applicationFileno" datatype="*1-20" ignore="ignore" type="text" style="width: 50px;border-style: none none solid none;border-color:#54A5D5;border-width: 1px;" class="inputxt" value='${tOApprovalPage.applicationFileno}' readonly="readonly">号</td>
  </tr>
  <tr>
...
<table style="width: 100%">
  <tr>
    <td>正文：</td>
    <td title="正文格式：${file.extend} 创建人：${file.createName} 创建时间：<fmt:formatDate value='${file.createDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>">(${file.extend}格式)&nbsp;${file.createName}&nbsp;<fmt:formatDate value='${file.createDate}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;<a class="easyui-linkbutton" data-options="plain:true" onclick="showMain()" href="#officecontrol" icon="icon-add">查看正文</a><a class="easyui-linkbutton" data-options="plain:true" onclick="sign()" href="#officecontrol" icon="icon-add">盖章</a></td>
  </tr>
</table>
