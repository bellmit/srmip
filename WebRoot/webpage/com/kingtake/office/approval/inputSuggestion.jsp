...
<!--   <script type="text/javascript" src="plug-in/ckfinder/ckfinder.js"></script> -->
 ...
 <body>
  <t:formvalid formid="formobj" refresh="true"  dialog="true" usePlugin="password" layout="table" action="tOApprovalController.do?doSuggestion&rid=${receive.id}&sCode=1"> 
