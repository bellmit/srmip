...
<html>
 <head>
  ...
  function checkReceive(){
	  ...
	  $.ajax({
		  ...
		  url:"tOApprovalController.do?checkReceive",
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOApprovalController.do?send"  callback="@Override submitParent" btnsub="saveBtn" > 
		...
		<table  cellpadding="0" cellspacing="1" class="formtable" style="margin-left: 200px;margin-top: 120px;line-height: 30px;font-size: 50px;">
				...
				<tr>
					...
					<td class="value" >
				<input type="hidden" name="receiverid" id="receiverid" value="${tOApprovalPage.contactId}" >
				<input type="hidden" name="departId" id="departId" value="${tOApprovalPage.undertakeUnitId}" >
				<input type="hidden" name="departName" id="departName" value="${tOApprovalPage.undertakeUnitName}" > 
				<input id="realName" style="width: 120px;" class="inputxt" name="realName"  readonly="readonly" datatype="*" value="${tOApprovalPage.contactName}" ></input>
