...
<!--   <script type="text/javascript" src="plug-in/ckfinder/ckfinder.js"></script> -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOReceiveBillController.do?send"  callback="@Override submitParent" btnsub="saveBtn" > 
		...
		<table  cellpadding="0 cellspacing="1" class="formtable" style="margin-left: 200px;margin-top: 120px;line-height: 30px;font-size: 50px;">
				...
				<tr>
					...
					<td class="value">
					     	 <textarea id="leaderReview" name="leaderReview"  style="width: 300px;" datatype="*0-200" rows="5" class="inputxt" placeholder="除批阅意见外的其他提醒事项"></textarea>
							<span class="Validform_checktip"></span>
