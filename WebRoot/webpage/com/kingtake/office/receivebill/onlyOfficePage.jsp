...
// 	$('#officecontrol').attr('style','display:block;height:800px;');
	...
	if(realPath){
		TANGER_OCX_openFromUrl('<%=rootPath%>/upload/template/swypdTH.docx',false);
		taoHong();
...
//	OFFICE_CONTROL_OBJ.SetBookmarkValue("公文编号","${tOReceiveBillPage.fileNumPrefix}﹝20${tOReceiveBillPage.fileNumYear}﹞${tOReceiveBillPage.billNum}");
