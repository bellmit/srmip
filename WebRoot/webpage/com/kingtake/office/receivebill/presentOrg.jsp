...
<!--   <script type="text/javascript" src="plug-in/ckfinder/ckfinder.js"></script> -->
  ...
  function submitParent(data){
	  var parentPage = window.parent.inputPage;
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOReceiveBillController.do?send&id=${id}" callback="@Override submitParent" beforeSubmit="checkReceive"> 
