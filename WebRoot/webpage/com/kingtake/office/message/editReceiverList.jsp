...
<t:datagrid name="noticeReceiverList" title="common.operation"
            actionUrl="tOMessageController.do?userDatagrid&messageid=${messageid}" fit="true" fitColumns="true" idField="id" queryMode="group">
...
<%-- 	<t:dgCol title="common.username" sortable="false" field="userName" query="true" isLike="true"></t:dgCol> --%>
	...
	<t:dgCol title="是否阅读" sortable="true" field="readFlag" replace="否_0,是_1" align="center" width="120"></t:dgCol>
	...
	<t:dgDelOpt title="common.delete" url="tOMessageController.do?delReceiver&userid={receiverId}&messageid=${messageid}" />
