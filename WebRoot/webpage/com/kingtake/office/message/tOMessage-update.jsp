	...
	<table cellpadding="0" cellspacing="1" style="margin:auto;width:600px;">
		...
		<tr>
			...
			<td class="value" colspan="3">
		     	<input id="title" name="title" type="text"  style="width:460px;" class="inputxt" value='${tOMessagePage.title}'   datatype="byterange" max="200" min="1">
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				 <textarea id="content" style="width:460px;" class="inputxt" rows="6" name="content" datatype="byterange" max="2000" min="1">${tOMessagePage.content}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tr>
			<td align="right">
				<label class="Validform_label">接收人:<font color="red">*</font></label>
			</td>
			<td class="value" colspan="3">
				<input id="receverid" name="receverid" type="hidden" value="${receverid}">
				<input style="width:340px;" id="recevername" name="recevername" type="text" value="${recevername}" readonly="readonly"  datatype="*">
