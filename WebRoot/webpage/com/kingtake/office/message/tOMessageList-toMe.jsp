...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:1px;">
		<t:datagrid name="tOMessageList" fitColumns="true" title="系统消息" 
			actionUrl="tOMessageController.do?datagridToMe&df=0" idField="id" 
			...
			<%-- <t:dgCol title="发送人删除标志" field="DEL_FLAG" hidden="true" queryMode="group" width="100"></t:dgCol>
			<t:dgCol title="删除时间" field="DEL_TIME" formatter="yyyy-MM-dd" hidden="true" queryMode="group" width="200" align="center"></t:dgCol> --%>
			
			<t:dgToolBar title="查看" icon="icon-search" funname="godetailview2"></t:dgToolBar>
            <t:dgToolBar title="标记已读" icon="icon-remark" funname="goReaded"></t:dgToolBar>
...
<script type="text/javascript">
  ...
  //回收站
    function goRecycle(){
        var title="我的回收站";
        var url = "tOMessageController.do?goRecycle";
