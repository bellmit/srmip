...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOVehicleExpenseController.do?doAdd" 
  	tiptype="1" tipSweep="true" beforeSubmit="valiBeforeSubmit">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
				     	<input id="vehicleId" name="vehicleId" type="hidden" style="width: 150px" 
				     		class="inputxt" value="${tOVehicleExpensePage.vehicleId}" >
				...
				<tr>
					...
					<td class="value">
				     	...
				     	<input id="useInfo" type="text" style="width: 150px" class="inputxt" readonly="readonly">
				...
				<tr>
					...
					<td class="value">
						<input id="payerId" name="payerId" type="hidden" >
				     	<input id="payerName" name="payerName" type="text" style="width: 150px" class="inputxt" datatype="*1-18" >
				...
				<tr>
					...
					<td class="value">
					    <t:codeTypeSelect id="expenseType" name="expenseType" type="select" 
					    	codeType="1" code="FYLX" extendParam="{onchange:hideOrShowFuelCharge()}"></t:codeTypeSelect>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	<input id="fuelCharge" name="fuelCharge" type="text"
				     		...
				     		data-options="min:0,max:99999999.99,precision:2,groupSeparator:','">L
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	<t:codeTypeSelect id="payType" name="payType" type="select" codeType="1" code="JYJFLX"></t:codeTypeSelect>
						<span class="Validform_checktip"></span>
