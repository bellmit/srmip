...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOVehicleUseController.do?doAdd" 
  	tiptype="1" tipSweep="true" beforeSubmit="valiBeforeSubmit">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<input id="vehicleId" name="vehicleId" type="hidden" style="width: 150px" class="inputxt" 
				     	...
				     	<input type="text" style="width: 150px" class="inputxt" readonly="readonly" value="${tOVehiclePage.licenseNo }">
					...
					<td class="value">
						<input id="driverId" name="driverId" type="hidden" style="width: 150px" class="inputxt" value="${tOVehiclePage.driverId }">
				     	<input id="driverName" name="driverName" type="text" style="width:45px" class="inputxt" 
				     		datatype="*1-18" value="${tOVehiclePage.driverName }">
				...
				<tr>
					...
					<td class="value">
						<input id="useId" name="useId" type="hidden" style="width: 150px" class="inputxt">
				     	<input id="useName" name="useName" type="text" style="width:45px" class="inputxt" datatype="*1-18">
				...
				<tr>
					...
					<td class="value" colspan="3	">
						<input id="projectId" name="projectId" type="hidden" >
				     	<input id="projectName" type="text" style="width: 350px" class="inputxt" readOnly="readonly">
				...
				<tr>
					...
					<td class="value"  colspan="3">
				     	<input id="acheivePlace" name="acheivePlace" type="text" style="width: 460px" class="inputxt" datatype="*1-75">
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
					    <textarea id="outReason" name="outReason"  style="width:460px;height:40px;" datatype="*1-400"></textarea>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	<input id="driverDistance" name="driverDistance" type="text" 
							...
							data-options="min:0,max:99999999.99,precision:2,groupSeparator:','">公里
						<span class="Validform_checktip"></span>
					...
					<td class="value">
				     	<input id="fuelUse" name="fuelUse" type="text" 
							...
							data-options="min:0,max:99999999.99,precision:2,groupSeparator:','">升
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<input id="approverId" name="approverId" type="hidden" style="width: 150px" class="inputxt">
				...
				<tr>
					...
					<td class="value" colspan="3">
				     	<textarea id="remark" name="remark" style="width:460px;height:30px;" datatype="*1-100" ignore="ignore"></textarea>
						<span class="Validform_checktip"></span>
