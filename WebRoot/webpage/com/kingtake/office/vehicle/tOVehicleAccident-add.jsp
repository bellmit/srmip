...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOVehicleAccidentController.do?doAdd" 
  	tiptype="1" tipSweep="true">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
				     	<t:codeTypeSelect id="handleMode" name="handleMode" type="select" codeType="1" code="CLFS"
				     		defaultVal="1" extendParam="{style:'width:270px'}"></t:codeTypeSelect>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
				     	<textarea id="remark" name="remark" style="width:265px;height:40px;" datatype="*1-100" ignore="ignore"></textarea>
						<span class="Validform_checktip"></span>
