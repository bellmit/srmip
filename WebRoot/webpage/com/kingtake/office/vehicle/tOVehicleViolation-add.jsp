...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOVehicleViolationController.do?doAdd" 
  	tiptype="1" tipSweep="true">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
				     	<input id="violationName" name="violationName" type="text" style="width: 150px" class="inputxt"
				     		datatype="*1-18">
				     	<input id="violationId" name="violationId" type="hidden">
				...
				<tr>
					...
					<td class="value">
			     		<textarea id="violationAddr" name="violationAddr" style="width:260px; height:50px;" 
			     			datatype="*1-75"></textarea>
						<span class="Validform_checktip"></span>
