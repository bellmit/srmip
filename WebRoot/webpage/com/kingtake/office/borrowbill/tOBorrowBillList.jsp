...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding: 1px;">
    <t:datagrid name="tOBorrowBillList" checkbox="true" fitColumns="true" title="收文借阅申请" actionUrl="tOBorrowBillController.do?datagrid" idField="id" fit="true" onDblClick="dbClickRow" queryMode="group">
      ...
      <t:dgCol title="审批通过时间" field="borrowBeginTime" formatter="yyyy-MM-dd" queryMode="group" width="120"></t:dgCol>
      <t:dgCol title="归还时间" field="borrowEndTime" formatter="yyyy-MM-dd" queryMode="group" width="120"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="icon-add" url="tOBorrowBillController.do?goUpdate" funname="add" width="100%" height="100%"></t:dgToolBar>
      ...
      <t:dgDelOpt exp="auditStatus#eq#0" title="删除" url="tOBorrowBillController.do?doDel&id={id}" />
      <t:dgFunOpt exp="auditStatus#eq#0" title="提交" funname="doBorrowBillSubmit(id)" ></t:dgFunOpt>
      <t:dgFunOpt exp="auditStatus#eq#3" title="提交" funname="doBorrowBillSubmit(id)" ></t:dgFunOpt>
      <t:dgFunOpt exp="auditStatus#eq#2" title="查看公文" funname="checkValid(id)" ></t:dgFunOpt>
