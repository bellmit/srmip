...
<%-- <t:base type="jquery,easyui,tools,DatePicker"></t:base> --%>
  <input id="srcScheduleId" type="hidden" value="${scheduleId }">
  <t:datagrid name="responseList" checkbox="true" fitColumns="true" title='<font color="red" style="font-size: 20px;">注：该面板针对该日程安排发给他人后，向接收人进行回复。</font>'
   ...
   <t:dgCol title="回复内容"  field="resContent" overflowView="true" width="120"></t:dgCol>
