...
<link rel="stylesheet" href="plug-in/colorpicker/css/colorpicker.css" type="text/css" />
<link rel="stylesheet" href="plug-in/colorpicker/css/layout.css" type="text/css" />
    
<script type="text/javascript" src="plug-in/ckfinder/ckfinder.js"></script>
<script type="text/javascript" src="plug-in/colorpicker/js/colorpicker.js"></script>
<script type="text/javascript" src="plug-in/colorpicker/js/eye.js"></script>
<script type="text/javascript" src="plug-in/colorpicker/js/utils.js"></script>
<script type="text/javascript" src="plug-in/colorpicker/js/layout.js?ver=1.0.2"></script>
...
$(function(){
    ...
    var select = $("#select").val();//选择tab页
    $("#schduleTab").tabs("select",parseInt(select));
});
...
<div id="schduleTab" class="easyui-tabs" fit="true">
<div title="日程安排信息">
<t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override reloadSchedule"
    ...
    <table cellpadding="0" cellspacing="1" class="formtable" >
      ...
      <tr>
        ...
        <td class="value" colspan="3"><input id="fileNum" name="fileNum" type="text" style="width:456px" class="inputxt"
      ...
      <tr>
        ...
        <td class="value" align="left"><input id="warnTimePoint" name="warnTimePoint" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt: 'HH:mm'})" 
        ...
        <td class="value" align="left"><t:codeTypeSelect id="warnFrequency" name="warnFrequency" codeType="0" code="WARNFREQUENCY" type="select" defaultVal="${tOSchedulePage.warnFrequency}"></t:codeTypeSelect>
...
<c:if test="${!empty tOSchedulePage.parentId}">
<div title="回复发送人"  data-options='href:"tOScheduleController.do?goMyResponseList&scheduleId=${tOSchedulePage.id }",fit:true' >
</div>
</c:if>
<div title="发送/留言"  data-options='href:"tOScheduleController.do?goSendReplyList&scheduleId=${tOSchedulePage.id }",fit:true' >
</div>
</div>
</body>
