...
<t:tab iframe="tOSendBillController.do?tOSendBillListToMe&operateStatus=${untreated}&registerType=${registerType}" 
	icon="icon-search" title="未处理" id="o"></t:tab>
<t:tab iframe="tOSendBillController.do?tOSendBillListToMe&operateStatus=${treated}&registerType=${registerType}" 
