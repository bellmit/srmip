...
<!--   <script type="text/javascript" src="plug-in/ckfinder/ckfinder.js"></script> -->
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tOSendBillController.do?send&id=${id}" callback="@Override submitParent" beforeSubmit="checkReceive"> 
