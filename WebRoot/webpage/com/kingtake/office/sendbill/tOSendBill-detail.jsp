...
<c:if test="${tOSendBillPage.createBy eq userName}">
	<div style="width: auto; height: 200px;">
	<div style="width: 100%; height: 1px;">
		<t:tabs id="tt1" iframe="false" tabPosition="top" fit="false">
			<t:tab href="tOSendBillController.do?getStepList&id=${tOSendBillPage.id}" icon="icon-search" title="流转步骤" id="tOSendBillStep"></t:tab>
		</t:tabs>
	</div>
	</div>
</c:if>
