...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override uploadFile"
        layout="table" action="tOPrivateMemoController.do?doAdd" tiptype="1">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <t:choose url="tPmProjectController.do?projectSelect" name="projectList" width="1000px" height="460px" 
                  ...
                  inputTextname="projectId,projectName" isclear="true" left="50%" top="50%"></t:choose>
                <span class="Validform_checktip"></span> 
