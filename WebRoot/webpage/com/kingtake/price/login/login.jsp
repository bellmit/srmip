...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><img src="plug-in/login/images/head.png" /><img src="plug-in/login/images/jeecg.png" /></div>
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="priceLoginController.do?login" check="priceLoginController.do?checkuser" method="post">
