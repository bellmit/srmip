...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tErReviewTypeController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sortCode" name="sortCode" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${tErReviewTypePage.sortCode}'>
							<span class="Validform_checktip"></span>
