...
<div region="center" style="padding: 1px;">
    <t:datagrid name="functionList" title="menu.manage" fit="true" fitColumns="true"
       	actionUrl="functionController.do?functionGrid" idField="id" treegrid="true" pagination="false">
        <t:dgCol title="common.id" field="id" treefield="id" hidden="true"></t:dgCol>
        <t:dgCol title="menu.name" field="functionName" treefield="text" width="100"></t:dgCol>
        <t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code" image="true" width="20"></t:dgCol>
        <t:dgCol title="funcType" field="functionType" treefield="functionType" width="50" 
        	replace="funcType.page_0,funcType.from_1"></t:dgCol>
        <t:dgCol title="menu.url" field="functionUrl" treefield="src" width="160"></t:dgCol>
        <t:dgCol title="menu.order" field="functionOrder" treefield="order" width="30" align="center"></t:dgCol>
        ...
        <t:dgToolBar title="common.edit.param" langArg="common.menu" icon="icon-edit" url="functionController.do?addorupdate" funname="update" width="680" height="450"></t:dgToolBar>
    </t:datagrid>
    </div>
</div>
<%--   update-start--Author:duanql  Date:20130619 for：操作按钮窗口显示控制--%>
...
function addFun(title,url, id) {
	...
	add(title,url,'functionList',680,450);
}
