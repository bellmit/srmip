...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding: 1px;">
        <t:datagrid name="noCurDepartUserList" title="common.operation"
                    actionUrl="departController.do?addUserToOrgList&orgId=${orgId}" 
            ...
            <t:dgCol title="common.real.name" field="realName" query="true" 
            	width="100"></t:dgCol>
            <t:dgCol title="common.status" sortable="true" field="status" width="100" 
...
<div style="display: none">
    <t:formvalid formid="formobj" layout="div" dialog="true" 
    	action="departController.do?doAddUserToOrg&orgId=${orgId}" 
