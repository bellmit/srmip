...
<div region="center" style="padding: 1px;">
	<t:datagrid name="roleList" title="common.role.list" fit="true" fitColumns="true" 
		actionUrl="roleController.do?roleGrid" idField="id">
		<t:dgCol title="common.code" field="id" hidden="true"></t:dgCol>
		<t:dgCol title="common.role.code" field="roleCode" width="100"></t:dgCol>
		<t:dgCol title="common.role.name" field="roleName" query="true" isLike="true" width="100"></t:dgCol>
		...
		<t:dgToolBar title="common.add.param" langArg="common.role" icon="icon-add" url="roleController.do?addorupdate" funname="add" width="660" height="200"></t:dgToolBar>
		<t:dgToolBar title="common.edit.param" langArg="common.role" icon="icon-edit" url="roleController.do?addorupdate" funname="update" width="660" height="200"></t:dgToolBar>
	</t:datagrid>
</div>
</div>
