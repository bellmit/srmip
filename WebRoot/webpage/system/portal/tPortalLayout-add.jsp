...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tPortalLayoutController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						  	 <textarea style="width:400px;" class="inputxt" rows="6" id="layoutCode" name="layoutCode"></textarea>
							<span class="Validform_checktip"></span>
