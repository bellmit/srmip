		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var j = 0; j < data.length; j++) {
					var p = $('<div style="overflow: hidden;"/>').appendTo($('#pp'));
					var param = {};
					param['border'] = 'true';
...
<div style="height:100%;width:99.3%;border:1px;float:left;">
<div id="pp" style="overflow-x:hidden;">
...
<div
	style="position: absolute;top: 2px;right: 5px;z-index: 10;width: auto;">
