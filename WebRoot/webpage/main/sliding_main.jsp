		...
		<div class="taskbar_start_menu_container" id="startMenuContainer" _olddisplay="block" style="display: none;">  
			...
			<div uin="0" class="taskbar_start_menu_selfinfo" id="startMenuSelfInfo">       
				<div style="float: left; line-height: 15px;">
                     <span style="color: #6DB6D9"><t:mutiLang langKey="common.user"/>: </span>
                     <span style="color: #FFFFFF">${userName }</span><br>
                     <%-- <a onclick="addTab('系统消息','tOMessageController.do?tOMessageTab&clickFunctionId=40288a854e41f2b7014e42515ca10027','default')" title="系统消息" url="tOMessageController.do" href="#" >
                    	<span style="color: #6DB6D9"><t:mutiLang langKey="系统消息"/>:</span>
                   		<span style="color: #FFFFFF" id="msgdiv">(0)</span><br>
                   	 </a> --%>
                     <span style="color: #6DB6D9"><t:mutiLang langKey="current.org"/>: </span>
                     <span style="color: #FFFFFF">${currentOrgName }</span><br>
                     <span style="color: #6DB6D9"><t:mutiLang langKey="common.role"/>: </span>
