...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
  <!-- 顶部-->
  <div region="north" border="false" title="科研管理信息系统  "
    style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/head.png;"> <img
          src="plug-in/login/images/foot.png"></td>
        <td align="right" nowrap>
          <table>
            <tr>
              <td valign="top" height="50"><span style="color: #CC33FF"><t:mutiLang langKey="common.user" />:</span>
                <span style="color: #666633">${userName }</span> <a
                onclick="addTab('系统消息','tOMessageController.do?tOMessageTab&clickFunctionId=40288a854e41f2b7014e42515ca10027','default')"
                title="系统消息" url="tOMessageController.do" href="#"> <span style="color: #CC33FF"><t:mutiLang
                      langKey="系统消息" />:</span> <span style="color: #666633" id="msgdiv">(0)</span>
              </a> <span style="color: #CC33FF"><t:mutiLang langKey="current.org" />:</span> <span style="color: #666633">${currentOrgName }</span>
                <span style="color: #CC33FF"><t:mutiLang langKey="common.role" />:</span> <span style="color: #666633"><c:if test="${fn:length(roleName)>10 }"><span title="${roleName}">${fn:substring(roleName,0,10)}...</span></c:if><c:if test="${fn:length(roleName)<=10 }">${roleName}</c:if></span>
              </td>
            </tr>
            <tr>
              <div style="position: absolute; right: 0px; bottom: 0px;">
                <a href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_kzmbMenu"
                  iconCls="icon-help"> <t:mutiLang langKey="common.control.panel" />
                </a> <a href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_zxMenu" iconCls="icon-back">
              ...
              <div id="layout_north_xtxxMenu" style="width: 100px; display: none;">
                <div class="menu-sep"></div>
                <div onclick="detail('tOMessageController.do?goupdate&flag=0&toid=1','<t:mutiLang langKey="查看消息"/>',1);">
                </div>
              </div>
            </tr>
          </table>
  ...
  <!-- 左侧-->
  <div region="west" split="true" href="loginController.do?left" title="<t:mutiLang langKey="common.navegation"/>"
  ...
  <div collapsed="true" region="east" iconCls="icon-reload" title="<t:mutiLang langKey="common.assist.tools"/>"
    ...
    <div class="easyui-layout" data-options="fit:'true'">
      <div data-options="region:'north'" style="height: 157px;">
        <div id="tabs" class="easyui-tabs" border="false" style="height: 150px">
      ...
      <div data-options="region:'center'">
        <div id="layout_jeecg_onlinePanel" data-options="fit:true,border:false"
