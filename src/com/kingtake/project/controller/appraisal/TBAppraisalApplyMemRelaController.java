...
public class TBAppraisalApplyMemRelaController extends BaseController {
	...
	/**
	 * T_B_APPRAISA_APPLY_MEM_RELA列表 页面跳转
	 * 
	 * @return
	 */
	...
	public AjaxJson doDel(TBAppraisalApplyMemRelaEntity tBAppraisaApplyMemRela, HttpServletRequest request) {
		...
		message = "T_B_APPRAISA_APPLY_MEM_RELA删除成功";
		try{
			tBAppraisaApplyMemRelaService.delete(tBAppraisaApplyMemRela);
			systemService.addLog(message, Globals.Log_Type_DEL, Globals.Log_Leavel_INFO);
		}catch(Exception e){
			e.printStackTrace();
			message = "T_B_APPRAISA_APPLY_MEM_RELA删除失败";
			throw new BusinessException(e.getMessage());
		}
		j.setMsg(message);
		return j;
	...
	/**
	 * 批量删除T_B_APPRAISA_APPLY_MEM_RELA
	 * 
	 * @return
	 */
	...
	public AjaxJson doAdd(TBAppraisalApplyMemRelaEntity tBAppraisaApplyMemRela, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		message = "T_B_APPRAISA_APPLY_MEM_RELA添加成功";
		try{
			tBAppraisaApplyMemRelaService.save(tBAppraisaApplyMemRela);
			systemService.addLog(message, Globals.Log_Type_INSERT, Globals.Log_Leavel_INFO);
		}catch(Exception e){
			e.printStackTrace();
			message = "T_B_APPRAISA_APPLY_MEM_RELA添加失败";
			throw new BusinessException(e.getMessage());
		}
		j.setMsg(message);
		return j;
	...
	public AjaxJson doUpdate(TBAppraisalApplyMemRelaEntity tBAppraisaApplyMemRela, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		message = "T_B_APPRAISA_APPLY_MEM_RELA更新成功";
		...
		try {
			...
			e.printStackTrace();
			message = "T_B_APPRAISA_APPLY_MEM_RELA更新失败";
			throw new BusinessException(e.getMessage());
		}
		j.setMsg(message);
		return j;
	...
	/**
	 * T_B_APPRAISA_APPLY_MEM_RELA新增页面跳转
	 * 
	 * @return
	 */
	...
	/**
	 * T_B_APPRAISA_APPLY_MEM_RELA编辑页面跳转
	 * 
	 * @return
	 */
	...
	public String exportXls(TBAppraisalApplyMemRelaEntity tBAppraisaApplyMemRela,HttpServletRequest request,HttpServletResponse response
		...
		modelMap.put(NormalExcelConstants.PARAMS,new ExportParams("T_B_APPRAISA_APPLY_MEM_RELA列表", "导出人:"+ResourceUtil.getSessionUserName().getRealName(),
			"导出信息"));
