 ...
 */
@Entity
@Table(name = "t_pm_contract_price_profit", schema = "")
@LogEntity("合同价款计价书--收益类计算书")
@SuppressWarnings("serial")
public class TPmContractPriceProfitEntity implements java.io.Serializable {
	/**主键*/
	@FieldDesc("主键")
	...
	/**
	 *方法: 取得Double
	 *@return: Double  报价栏（百分比）
	 */
	@Column(name ="PRICE_PERCENT",nullable=true,scale=2,length=6)
	...
	/**
	 *方法: 取得Double
	 *@return: Double  审核栏（百分比）
	 */
	@Column(name ="AUDIT_PERCENT",nullable=true,scale=2,length=6)
