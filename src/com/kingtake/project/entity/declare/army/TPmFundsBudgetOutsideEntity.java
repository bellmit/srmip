 ...
 */
@Entity
@LogEntity("经费预算明细表-外协费（军内科研）")
@Table(name = "t_pm_funds_budget_outside", schema = "")
@SuppressWarnings("serial")
public class TPmFundsBudgetOutsideEntity implements java.io.Serializable {
	/**主键*/
	@FieldDesc("主键")
	...
	@FieldDesc("外协内容")
	@Excel(name="外协内容")
	private java.lang.String outsideContent;
	/**外协单位*/
	@FieldDesc("外协单位")
	@Excel(name="外协单位")
	private java.lang.String outsideUnit;
	/**经费*/
	@FieldDesc("经费")
	@Excel(name="经费")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  外协内容
	 */
	@Column(name ="OUTSIDE_CONTENT",nullable=true,length=50)
	public java.lang.String getOutsideContent(){
		return this.outsideContent;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  外协内容
	 */
	public void setOutsideContent(java.lang.String outsideContent){
		this.outsideContent = outsideContent;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  外协单位
	 */
	@Column(name ="OUTSIDE_UNIT",nullable=true,length=60)
	public java.lang.String getOutsideUnit(){
		return this.outsideUnit;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  外协单位
	 */
	public void setOutsideUnit(java.lang.String outsideUnit){
