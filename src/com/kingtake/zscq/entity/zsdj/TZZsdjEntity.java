package com.kingtake.zscq.entity.zsdj;
 ...
 * @date 2016-07-15 09:21:06
 * @version V1.0
 * 
 */
@Entity
@Table(name = "t_z_zsdj", schema = "")
@SuppressWarnings("serial")
public class TZZsdjEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name = "shggr")
    public Date getShggr() {
		return shggr;
	}

	public void setShggr(Date shggr) {
		this.shggr = shggr;
	}
