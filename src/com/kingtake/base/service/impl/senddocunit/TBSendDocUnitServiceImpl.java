package com.kingtake.base.service.impl.senddocunit;
...
@Service("tBSendDocUnitService")
@Transactional
public class TBSendDocUnitServiceImpl extends CommonServiceImpl implements TBSendDocUnitServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((TBSendDocUnitEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((TBSendDocUnitEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((TBSendDocUnitEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TBSendDocUnitEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{unit_name}",String.valueOf(t.getUnitName()));
 		sql  = sql.replace("#{unit_short_name}",String.valueOf(t.getUnitShortName()));
