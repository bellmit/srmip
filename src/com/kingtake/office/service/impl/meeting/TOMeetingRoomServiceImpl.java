...
@Service("tOMeetingRoomService")
@Transactional
public class TOMeetingRoomServiceImpl extends CommonServiceImpl implements TOMeetingRoomServiceI {
    ...
    public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((TOMeetingRoomEntity)entity);
 	}
    ...
    public <T> Serializable save(T entity) {
 		...
 		//执行新增操作配置的sql增强
 		this.doAddSql((TOMeetingRoomEntity)entity);
 		return t;
 	}
    ...
    public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((TOMeetingRoomEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TOMeetingRoomEntity t){
 		...
 		sql  = sql.replace("#{maxnum}",String.valueOf(t.getMaxnum()));
