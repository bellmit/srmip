...
public class RTXSvrApi {
    ...
    private Log log = LogFactory.getLog(RTXSvrApi.class);
   ...
   public int getServerPort(){
     ...
     * @return int 0 操作成功 非0为失败
     */
    public int SetUserSimpleInfo(String UserName, String ChsName, String email, String gender, String mobile,
        ...
        if ( innerCode!= 0) {
            release();
            throw new BusinessException("错误代码:" + innerCode + "\t" + "错误信息：" + GetResultErrString(iResult));
            //return innerCode;
        } else {
            int iProps = GetResultPropertys(iResult);
            int iCount = GetPropertysCount(iProps);
     ...
     * @return int 0 操作成功 非0为失败
     */
    public int SetUserSimpleInfoEx(String UserName, String DeptID, String ChsName, String email, String gender,
            String mobile, String phone, String pwd) {
   ...
   public String getSessionKey(String UserName){
     ...
     *            String 发送人
     * @param receiver
     *            String 接收人(RTX用户或手机号码均可,最多128个)
     * @param smsInfo
     *            String 短信内容
     * @param autoCut
     *            int 是否自动分条发送 0:否 1:是
     * @param noTitle
     *            int 是否自动填写标题 0:自动 1:制定
   ...
   public int sendSms(String sender, String receiver, String smsInfo,int autoCut, int noTitle) {
       ...
       if ( innerCode != 0)
       {
            log.error("错误代码:" + innerCode + "\t" + "错误信息：" + GetResultErrString(iResult));
       }
       release();
       return innerCode;
   }
    ...
    public static void main(String args[]) {
        ...
        int info = rtxApi.sendNotify("zhangsan", "发工作计划", "test，test", "0", "0");
