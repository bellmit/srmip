...
public class LogController extends BaseController {
    ...
    public void datagrid(TBLog tbLog, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        CriteriaQuery cq = new CriteriaQuery(TBLog.class, dataGrid);
        org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tbLog);
	...
	public List<Highchart> getBroswerBar(HttpServletRequest request,String reportType, HttpServletResponse response) {
        ...
        sb.append("SELECT broswer ,count(broswer) FROM TBLog group by broswer");
