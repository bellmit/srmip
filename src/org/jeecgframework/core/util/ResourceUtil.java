...
public class ResourceUtil {
	...
	public static final TSUser getSessionUserName() {
        ...
        if (session != null && ClientManager.getInstance().getClient(session.getId()) != null) {
     ...
     * @return
     */
    public static final TErExpertUserEntity getSessionExpert() {
        HttpSession session = ContextHolderUtils.getSession();
        if (session != null && ExpertClientManager.getInstance().getClient(session.getId()) != null) {
            return ExpertClientManager.getInstance().getClient(session.getId()).getExpert();
        }
        return null;
    }
	@Deprecated
