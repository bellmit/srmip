...
public class ParseWordUtil {
    ...
    public static Object getValueDoWhile(Object object, String[] paramsArr, int index) throws Exception {
        ...
        if (object instanceof Map) {
            ...
            object = POIPublicUtil.getMethod(paramsArr[index], object.getClass()).invoke(object, new Object[] {});
        }
        return (index == paramsArr.length - 1) ? (object == null ? "" : object) : getValueDoWhile(object, paramsArr,
                ++index);
    }
    ...
    public static Object[] getIsAndType(WordImageEntity entity) throws Exception {
        ...
        if (entity.getType().equals(WordImageEntity.URL)) {
            ...
            ImageIO.write(bufferImg,
                    entity.getUrl().substring(entity.getUrl().indexOf(".") + 1, entity.getUrl().length()), byteArrayOut);
