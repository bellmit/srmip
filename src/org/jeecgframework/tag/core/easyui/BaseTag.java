...
//            update-end--Author:zhangguoming  Date:20140521 for：云桌面图标拖拽、用户自定义桌面
			...
			if (oConvertUtils.isIn("portal", types)) {
				sb.append("<link rel=\"stylesheet\" href=\"plug-in/portal/portal.css\" type=\"text/css\"></link>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/portal/jquery.portal.js\"></script>");
			}
            if (oConvertUtils.isIn("bootstrap", types)) {
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/bootstrap/css/bootstrap.min.css\">");
                sb.append("<link rel=\"stylesheet\" href=\"plug-in/bootstrap/css/bootstrap-responsive.min.css\">");
                sb.append("<script src=\"plug-in/bootstrap/js/bootstrap.min.js\"></script>");
            }
