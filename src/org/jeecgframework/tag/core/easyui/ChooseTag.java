...
public class ChooseTag extends TagSupport {
	...
	public StringBuffer end() {
        ...
        sb.append("<a href=\"#\" class=\"easyui-linkbutton\" plain=\"true\" icon=\""
                ...
                + "\" onClick=\"choose_"
                + methodname
                + StringUtil.replace("()\" title=\"{0}\"></a>", "{0}",
                        MutiLangUtil.getMutiLangInstance().getLang("common.select", langArg)));
		if (isclear&&StringUtil.isNotEmpty(textname)) {
            sb.append("<a href=\"#\" class=\"easyui-linkbutton\" plain=\"true\" icon=\"icon-redo\" onClick=\"clearAll_"
                    + methodname
                    + StringUtil.replace("();\" title=\"{0}\"></a>", "{0}",
                            MutiLangUtil.getMutiLangInstance().getLang("common.clear", langArg)));
		}
