...
public class FormValidationTag extends TagSupport {
    ...
    protected boolean tipSweep = false;
    protected boolean postonce = true;
	...
	public void setPostonce(boolean postonce) {
		this.postonce = postonce;
	}
	...
	public int doEndTag() throws JspException {
		try {
            ...
            if ("showValidMsg".equals(this.getTiptype())) {
                sb.append(this.getCustomTiptype());
            }
			sb.append("$(function(){");
...
//			sb.append("},");
     ...
     * @return
     */
    private String getCustomTiptype() {
        StringBuffer sb = new StringBuffer();
        sb.append("function showValidMsg(msg, o, cssctl) {");
        sb.append(" var msgobj;");
        sb.append("  if ($(\"#Validform_msg\").length !== 0) {");
        sb.append("    $(\"#Validform_msg\").find(\"div.Validform_info\").text(msg);");
        sb.append("   msgobj = $(\"#Validform_msg\");");
        sb.append(" } else {");
        sb.append("   msgobj = $('<div id=\"Validform_msg\"><div class=\"Validform_title\">提示信息<a class=\"Validform_close\" href=\"javascript:void(0);\">&chi;</a></div><div class=\"Validform_info\">'");
        sb.append("   + msg + '</div><div class=\"iframe\"><iframe frameborder=\"0\" scrolling=\"no\" height=\"100%\" width=\"100%\"></iframe></div></div>').appendTo(\"body\");");
        sb.append("  msgobj.find(\"a.Validform_close\").click(function() {msgobj.delay(500).hide(0);return false;});");
        sb.append(" msgobj.click(function() {msgobj.hide();});");
        sb.append("  }");
        sb.append(" msgobj.show().delay(3000).hide(0);");
        sb.append(" var left = ($(window).width() - msgobj.outerWidth()) / 2, top = o.obj.offset().top + msgobj.outerHeight();");
        sb.append(" msgobj.css({left : left}).animate({top : top}, {duration : 400,queue : false});}");
        return sb.toString();
    }
