...
public class AutocompleteTag extends TagSupport {
    ...
    public StringBuffer end() {
        ...
        nsb.append("$(document).ready(function() {")
                ...
                .append("max: 5,minChars: " + minLength
                        + ",width: 200,scrollHeight: 100,matchContains: true,autoFill: false,extraParams:{")
                .append("featureClass : \"P\",style : \"full\",	maxRows : " + maxRows + ",labelField : \"" + labelField
        ...
        nsb.append("}); });")
                ...
                .append("<input type=\"text\" id=\"" + name + "\" name=\"" + name
                        + "\" style=\"width:150px;\" datatype=\"" + datatype + "\" nullmsg=\"" + nullmsg
                        + "\" errormsg=\"" + errormsg + "\"");
        if (StringUtil.isNotEmpty(label)) {
            nsb.append(" value=" + label + ">");
        } else {
            nsb.append(">");
        }
