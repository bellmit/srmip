...
public class ProcessInstanceController {
	...
	public void myRunningProcessListDataGrid(HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        ...
        List<HistoricProcessInstance> list = historicProcessInstanceQuery.orderByProcessInstanceStartTime().desc()//2015-08-31 zcq修改，正序改为倒序
		...
		for(HistoricProcessInstance hi : list){
            ...
            String businessKey = hi.getBusinessKey();//业务id
            ...
            if (queryList.size() > 0) {
                ...
                businessName = (String) result.get("BUSINESS_NAME");//获取业务名称
            }
